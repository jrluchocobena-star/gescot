...
function validarHorarioGestorIncidencia(horainicio, minutoinicio, horafin, minutofin) {
	...
	alert("entradaMin="+entradaMin+", entradaReqMin="+entradaReqMin+",salidaReqMin="+salidaReqMin);
    //alert("hor.sal="+salidaMin+", horario sal="+salidaReqMin);
	

    if (entradaMin > entradaReqMin || entradaMin < salidaReqMin) {
	...
	else if (salidaMin > salidaReqMin || salidaMin < salidaReqMin) {
		errores.push({
			error: true,
