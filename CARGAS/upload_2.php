						...
						if ($fila=='1'){
							...
							if($datos[0]=='REGISTRAR'){
								...
								if ($numfilas==0){
									...
									$sql="SEL idempleadolegado, nombresyapellidos, direccioncorreoelectronico, positiontitulo  FROM dbi_cot.ls_maestra_recursos WHERE idnacionalprincipal=$dni_gestor";
