...
//		echo $sup;	
		...
		echo "<td class='casilla_texto'>"; // FECHA NACIMIENTO
		echo $reg_lis[28]; 				
		echo "</td>";

		echo "<td class='casilla_texto'>"; // OLA
		echo $reg_lis[37];
		echo "</td>";

		echo "<td class='casilla_texto'>"; // MAC ADDRESS
		echo $reg_lis[40];
		echo "</td>";

		echo "<td class='casilla_texto'>"; // PLACE
		echo $reg_lis[41];
		echo "</td>";

		echo "<td class='casilla_texto'>"; // IP AUDIOCODE
		echo $reg_lis[42];
		echo "</td>";

		echo "<td class='casilla_texto'>"; // EQUIPO
		echo $reg_lis[43];
		echo "</td>";
