...
#Obtenemos el últio archivo de averías masivas cargado en el compartido
$pathfile = null;
$timestamp = null;
$dirname = "\\\\10.226.5.114\\FS-Principal\\Dir_Marketing\\Ger_Consumo_de_Terminales_y_Banda_Ancha\\Jefatura_de_Terminales\\000Cot\\zz_InputsExternos\\LiqMasivas\\";
...
#echo $dirname.$pathfile;
#echo "</BR>";
#echo $timestamp;
#echo "</BR>";
#echo $date->format('U = Y-m-d H:i:s') . "\n";
#if ( $xlsx = SimpleXLSX::parse('\\\\10.226.5.114\\FS-Principal\\Dir_Marketing\\Ger_Consumo_de_Terminales_y_Banda_Ancha\\Jefatura_de_Terminales\\000Cot\\zz_InputsExternos\\\LiqMasivas\\Base_Telefonos_LS_R001.xlsx') ) {

#Con el último archivo creamos el archivo de carga a PSI en formato csv
foreach (glob($dirname."*.xlsx") as $file) {
	#echo $file;
	#if ( $xlsx = SimpleXLSX::parse($dirname.$pathfile) ) {
