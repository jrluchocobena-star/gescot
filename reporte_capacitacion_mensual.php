...
$lista="(select *,SEC_TO_TIME((TIMESTAMPDIFF(MINUTE ,fec_ini_inc, fec_fin_inc))*60) AS diferencia,
	...
	from cab_capacitacion WHERE $cad 
	order by fec_reg desc)
	union
	(select *,SEC_TO_TIME((TIMESTAMPDIFF(MINUTE ,fec_ini_inc, fec_fin_inc))*60) AS diferencia,
	SUBSTR(fec_ini_inc,1,7)  
	from cab_capacitacion WHERE $cad 
	order by fec_reg desc)";
...
$i=0;
	...
	echo "<table width='100%'  style='border-collapse:collapse'>";		
			...
			echo "<td class='fdotxttabla2'>C.INCIDENCIA</td>";	
			...
			echo "<td class='fdotxttabla2'>CORRELATIVO</td>";
			echo "<td class='fdotxttabla2'>FEC.REGISTRO</td>";		
			echo "<td class='fdotxttabla2'>MOTIVO CAP.</td>";			
			echo "<td class='fdotxttabla2'>CURSO</td>";							
