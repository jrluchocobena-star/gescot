...
$n_archivo="rep_incidenciascot_".date("Y-m").".xls";
...
echo "<input name='dni_' type='hidden' id='dni_'>"; 				
			...
			echo "<table width='80%'>";	
				...
				echo "<tr>";					
					echo "<td class='celda_cab' width='10%'>DNI</td>";
					echo "<td class='celda_cab' width='30%'>NCOMPLETO</td>";
					echo "<td class='celda_cab' width='10%'>MES</td>";					
					echo "<td class='celda_cab' width='5%'  align='center' >MODO</td>";	
					echo "<td class='celda_cab' colspan='2'  align='center' >TIEMPO</td>";							
				echo "</tr>";									
