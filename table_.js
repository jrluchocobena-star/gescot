...
{
	try {ajaxp = new ActiveXObject("Msxml2.XMLHTTP");}
	catch (e) {
			try {ajaxp = new ActiveXObject("Microsoft.XMLHTTP");}
			catch (E) {ajaxp = false;}
	}
	if (!ajaxp && typeof XMLHttpRequest!='undefined') {
...
function listar_bandeja(tp,cargo){	
	var j_oper = document.getElementById("oper").value;		
	
	if (tp==1){
	document.getElementById("bandeja_averias").style.display="block";
	document.getElementById("bandeja_wifi").style.display="none";
	document.getElementById("bandeja_reagenda").style.display="none";	
	var contenedor1 = document.getElementById("bandeja_averias");	
	ajaxp=createRequest();
	var urlx = "bandeja_1.php?tp="+tp+"&operador="+j_oper+"&cargo="+cargo;		
	}
	if (tp==2){
	document.getElementById("bandeja_averias").style.display="block";
	document.getElementById("bandeja_wifi").style.display="none";
	...
	if (tp==3){		
	document.getElementById("bandeja_averias").style.display="none";	
	document.getElementById("bandeja_wifi").style.display="block";
	document.getElementById("bandeja_reagenda").style.display="none";	
	var contenedor1 = document.getElementById("bandeja_wifi");	
	ajaxp=createRequest();
	var urlx = "bandeja_wifi.php?tp="+tp+"&operador="+j_oper+"&cargo="+cargo;		
	}
	if (tp==4){		
	document.getElementById("bandeja_averias").style.display="none";	
	document.getElementById("bandeja_wifi").style.display="none";
	document.getElementById("bandeja_reagenda").style.display="block";	
	var contenedor1 = document.getElementById("bandeja_reagenda");	
	ajaxp=createRequest();
	var urlx = "bandeja_reagenda.php?tp="+tp+"&operador="+j_oper+"&cargo="+cargo;		
	}

/*
	var j_ec = document.getElementById("grupoX").value;		
	var j_cont = document.getElementById("contrata").value;			*/
	
	//alert(urlx)
	ajaxp.open("GET", urlx,true);
	ajaxp.onreadystatechange=function() {
		//alert(ajaxp.responseText);
		if (ajaxp.readyState==4) 
		{
			contenedor1.innerHTML = ajaxp.responseText
//			setTimeout(historico, iInterval);
		}
	}
	 ajaxp.send(null)
}