...
function reporte_inc(opc) {
	...
	if (opc == "1") {
		var url =
			"reporte_incidencias_nuevo_v2.php?iduser=" +
			iduser +
			"&idperfil=" +
			idperfil +
			"&u_reg=" +
...
function validarHorarioGestorIncidencia(horainicio, minutoinicio, horafin, minutofin) {
	...
	alert("Horario Persona\n entradaReqMin="+entradaReqMin+", salidaReqMin="+salidaReqMin);
	alert("entradaMin="+entradaMin+", salidaMin="+salidaMin);
	...
	if (salidaMin > salidaReqMin || salidaMin < entradaReqMin) {
		errores.push({
			error: true,
...
function mostrar_modulos_mant(opc) {
	...
	if (opc == "1") {
		document.getElementById("mod_mant_motivoincidencias").style.display =
			"block";
