...
$lista="select CIUDAD,PEDIDO,INSCRIPCION,DIRECCION,DISTRITO,PROMOCION,GRUPO,NRO_REF,FECHA_REG,TIPO_SERVICIO,PRIORIDAD,OFIC_COM,PETICION,
			AGRUPACION,CLIENTE,CUENTA,PC,NEGOCIO,PREFIJO,SEGMENTO,CANTIDAD,SUB_SEGMENTO,IRIS,DIRECCION_ANTIGUA,SECTOR,MANZANA,COORD_X,COORD_Y,ZON 
			from tb_gestel_423_tot WHERE SUBSTR(fecha_reg,4,5)='$xmes' and zon in('ARE','TRU','PIU','IQU','HYO','CHB','CHY','CUZ','ICA') group by 2 order by fecha_reg";
//echo $lista;
