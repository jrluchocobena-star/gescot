<?php
	...
	//Consulta
	$sql = "SELECT id_area, area, responsable FROM area_cot";
	...
	$objPHPExcel->getActiveSheet()->setCellValue('C6', 'RESPONSABLE');
	
	//Recorremos los resultados de la consulta y los imprimimos
	while($rows = $resultado->fetch_assoc()){
		
		$objPHPExcel->getActiveSheet()->setCellValue('A'.$fila, $rows['id_area']);
		$objPHPExcel->getActiveSheet()->setCellValue('B'.$fila, $rows['area']);
		$objPHPExcel->getActiveSheet()->setCellValue('C'.$fila, $rows['responsable']);
