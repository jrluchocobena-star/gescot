        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="58%"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td colspan="17" class="texto_sb"><?php echo "Formulario: <a class='texto_sb'>cab_maestracot.php</a>"; ?></td>
                        </tr>
                        <tr>
                            <td width="6%" valign="top" class="caja_texto_pe">SUPERVISOR</td>
                            <td width="9%" valign="top" class="caja_texto_pe">
                            ...
                            <td width="5%" valign="top" class="caja_texto_pe">NOM. Y APE.</td>
                            <td width="20%" valign="top" class="caja_texto_pe">
                                <input name="xcompleto" type="text" class="caja_texto_pe input" id="xcompleto" /></td>
                            <td width="4%" valign="top" class="caja_texto_pe">CIP</td>
                            <td width="8%" valign="top" class="caja_texto_pe"><input name="xcip" type="text" class="caja_texto_pe" id="xcip" size="15" maxlength="10" /></td>
                            <td width="6%" valign="top" class="caja_texto_pe">DNI</td>
                            <td width="8%" valign="top" class="caja_texto_pe">
                        ...
                        <tr>
                            <td colspan="9" class="titlat">&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="9">
                                <table width="60%" border="0">
                                    <tr>
                                        <td width="21%" class="caja_texto_pe" onclick="javascript:ventana_modal('3')">
                                            <img src="image/usumas.jpg" width="25" height="25" title="Nuevo Usuario" />
                                            Registrar gestor</td>
                                        <td width="21%" class="caja_texto_pe" id="bt_nuevo" 
                                            onclick="javascript:blanquea_criterio()">
                                            <img src="image/stock_copy.png" width="25" height="25" title="NUEVO"/>Nuevo busqueda          </td>
<!--
                                        <td width="22%" class="caja_texto_pe" onclick="javascript:ventana_modal('2')">
                                            <img src="image/BT3.gif" title="Exportar" width="30" height="25"/>Organizacion</td>        
-->
                                        <td width="12%" class="caja_texto_pe" id="bt_editar" style="display:none" 
                                            onclick="javascript:mostrar_edicion_maestra('<?php echo "2"; ?>')">
                                            <img src="image/liquidar.jpg" title="Editar" width="25" height="25"/>Editar       
                                        </td>
        ...
        <p>
            <div id="bandeja_criterios" style="display:block"> 
                <iframe id="lista_criterios"  frameborder="0" vspace="0"  hspace="0"  marginwidth="0"  marginheight="0"s style="border-collapse:collapse" class="marco_tabla"
                         width="99.8%"   scrolling="Auto"  height="700"> 
                </iframe>
            </div>
            <p>
