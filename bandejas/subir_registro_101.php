...
$iduser=$_GET["iduser"];
	...
	$sql_1a="delete from wt_solicitudes_historicos where celular=''";	
	//echo "<p>".$sql;
	$res_1a= mysql_query($sql_1a,$connection_w101) or die ($sql_1);
	...
	$sql_4a="UPDATE wt_maestra_consultas SET celular = CONCAT('+51',celular) WHERE LENGTH(celular)=9";	
		//aecho "<p>".$sql;
	$res_4a = mysql_query($sql_4a,$connection_w101) or die (mysql_error());
...
WHERE a.xdni=b.dni AND a.xcarnet=b.carnet AND a.celular=b.nrocel";	
	...
	$sql_26="UPDATE wt_maestra_consultas SET resultado='CELULAR INCORRECTO, TIENE MENOS DE 9 DIGITOS' WHERE LENGTH(celular)<9";	
	//echo "<p>".$sql_25;
	$res_26 = mysql_query($sql_26,$connection_w101) or die (mysql_error());
