...
$cad="select * from movimiento_usuarios order by fec_mov desc";
//echo $cad;
$res =mysql_query($cad);		
...
<thead>
  <tr>
			...
			echo "<th class='table-filterable'>GESTOR</th>";
												
			echo "<th class='table-filterable'>PROCESO</th>";
			...
			echo "<th class='filterable table-sortable:default sort01'>FECHA MOV";						
			echo "<input name='filter' size='15' maxlength='15' onkeyup='Table.filter(this,this)'></th>";
...
<tbody>
		...
		$d="select ncompleto from tb_usuarios where dni='".$reg[6]."'";
		//echo $q;
		$rs_d = mysql_query($d);											
