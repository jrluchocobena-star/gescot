...
$sql_2="select iduser,ncompleto,dni,cip,c_supervisor,c_monitor,local,ola from tb_usuarios where estado='HABILITADO' ";
//echo $sql_2;
...
<body>
<input name="arr_escogidos" type="text" class="caja_sb_st" id="arr_escogidos" readonly />
...
<input name="opc" type="hidden" class="caja_texto_sb" id="opc" />
		...
		<table width="100%">
		<tr>		
        <td colspan="3"><div id="d_supervisor" style="display:none">
        <table width="80%" border="0" class="marco_tabla">
          <tr>
            ...
            <td width="20%" class="caja_texto_pe" onclick="javascript:grabar_cambios()">
        ...
        <td width="27%" colspan="2" align="right"> 
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
			  <td width="20%" class="caja_texto_pe" id="add_part" >
                <img src="../image/LISTAS.JPG" width="20" height="20" onclick="javascript:agregar_gestores()" />Agregar participantes</td>
                <td width="20%" class="caja_texto_pe" id="add_part" onclick="javascript:mostrar_cambios('4')">
                <img src="../image/panel.jpg" width="25" height="30" />Grabar</td>                
                <td width="20%" class="caja_texto_pe" onclick="javascript:cerrar_win('3')"><img src="../image/SAL.jpg" width="25" height="30" />Salir</td>
              </tr>
		</table>
...
<thead>
  ...
  <tr>
			...
			echo "<th class='table-filterable table-sortable:default'>OLAS</th>";
			?>	
  </tr>
</thead>
<tbody>
...
<div id="registro_gestores" style="display:none">
		<table width="70%" border="0" cellpadding="1" cellspacing="1">
		  ...
		  <tr>
			...
			<td colspan="2"><input name="c_incidencia" type="text" class="aviso" id="c_incidencia" size="30" readonly /></td>
		  </tr>
		  <tr>
		...
		<select name="select" class="caja_sb" id="select" 
