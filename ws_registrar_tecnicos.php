...
function validar_cdc(){	
		...
		return
			...
			var urlx = "ws_funciones_asignaciones.php?iduser="+iduser+"&usuario="+usuario+"&dni="+dni+"&carnet="+carnet+"&accion="+accion;		
			//alert(urlx)			
...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco_tabla">
  <tr>
    <td colspan="7" valign="top" class="caja_texto_VERDE_GR">MODULO DE REGISTRO Y SEGUIMIENTO USSD - 101 </td>
  </tr>
  <tr>
    <td width="16%" valign="top" class="cabeceras_grid_color_cel" onclick="JAVASCRIPT:mostrar_div_ussd('1')">Gestion USSD 101 </td>
    <td width="14%" valign="top" class="cabeceras_grid_color_cel" onclick="JAVASCRIPT:mostrar_div_ussd('2')">Gestion CDC </td>
   <!-- <td width="22%" valign="top" class="cabeceras_grid_color_cel" onclick="JAVASCRIPT:mostrar_div_ussd('3')">Bandeja de Aprobaciones </td>-->
    <td width="20%" valign="top" class="cabeceras_grid_color_cel" onclick="JAVASCRIPT:mostrar_div_ussd('4')">Upload Masivo</td>
	 <td width="" valign="top" class="cabeceras_grid_color_cel" onclick="JAVASCRIPT:mostrar_div_ussd('')">&nbsp;</td>
	  <td width="" valign="top" class="cabeceras_grid_color_cel" onclick="JAVASCRIPT:mostrar_div_ussd('')">&nbsp;</td>
  </tr>
</table>
<br>

<div id="div_registro_ussd" style="display:block">
  <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco_tabla">
    <tr>
      <td width="13%" valign="top" class="caja_sb">&nbsp;</td>
    ...
    <tr>
      <td valign="top" class="caja_sb">CARNET</td>
      <td valign="top"><input name="xcarnet" type="text" class="caja_texto_pe" id="xcarnet" /></td>
      <td width="13%" valign="top" class="caja_sb">DNI</td>
      <td width="17%" valign="top"><input name="xdni" id="xdni" type="text" class="caja_texto_pe"  onkeypress="return justNumbers(event);" maxlength="8" /></td>
      <td width="14%" valign="top" class="caja_sb">NUMERO CELULAR</td>
      <td width="28%" valign="top" ><input name="postal2" type="text" class="caja_texto_pe" id="postal2" value="+51" size="5" maxlength="3" readonly="readonly" />
        <input name="a_celular" id="a_celular" type="text" class="caja_texto_pe"  onkeypress="return justNumbers(event);" size="9" maxlength="9" /></td>
    </tr>
    ...
    <tr>
	  ...
	  <table width="30%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="27%" class="caja_texto_pe" onclick="javascript:validar_celular()" align="center"><img src="image/busca3.jpg" width="30" height="30" /> BUSCAR </td>
            <td width="32%" class="caja_texto_pe"onclick="javascript:popup_ussd('1')" align="center"><img src="image/BT6.gif" width="30" height="30" /> MOVIMIENTOS </td>
...
<div id="div_cab_registro_cdc" style="display:none">
  <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco_tabla">
    <tr>
      <td width="6%" valign="top" class="caja_sb">&nbsp;</td>
      <td width="14%" valign="top">&nbsp;</td>
      <td colspan="3" valign="top">&nbsp;</td>
      <td width="14%" valign="top" class="TitTablaC">&nbsp;</td>
    </tr>
    <tr>
...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco_tabla"> 
  ...
  <tr>
	...
	<div id="div_consulta" style="display:"none"></div>
	
	<div id="div_upload" style="display:none">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <th colspan="3" class="caja_texto_db" >CARGAS MASIVAS DE LOS TECNICOS USSD 101 Y CDC </th>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td width="26%" class="caja_sb">Carga Masiva de Registro USSD </td>
          <td width="12%"><img src="image/upload12.jpg" width="30" height="30" onclick="javascript:sube_archivo_masivo('1')" /></td>
          <td width="62%">&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td class="caja_sb">Carga Masiva de Registro CDC </td>
          <td><img src="image/upload1.jpg" width="30" height="30" onclick="javascript:sube_archivo_masivo('2')"/></td>
          <td >Usuario Modelo 
            <label>
            <input name="textfield" type="text" class="caja_texto_pe"/>
            </label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
  ...
  <tr>
    <td valign="top" colspan="8"><div id="bandeja_tecnicos"></div></td>
  </tr>
  <tr>
    <td valign="top" colspan="8"><div id="div_data_registro"></div></td>		
  </tr>  
</table>

<br>
<div id="div_registro_celular" style="display:none">
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="marco_tabla"> 
  ...
  <tr>
    ...
    <td colspan="4" class="TitTablaC"><table width="82%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="115" class="caja_texto_pe" align="center" onclick="javascript:volver('1')" style="color:#0000FF">Cancelar</td>
        <td width="93" align="center" class="caja_texto_pe" onclick="javascript:grabar_registro_tecnicos()" style="color:#0000FF">Guardar</td>
  ...
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top" class="caja_texto_pe">N.CELULAR</td>
    <td colspan="2"><input name="pre" type="text" class="caja_texto_pe" id="pre" value="+51" size="2" maxlength="3" readonly />
    <input name="celular" type="text" class="caja_texto_pe" id="celular" readonly /></td>
    <td width="25%" valign="top" class="TitTablaC">&nbsp;</td>
    </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top" class="caja_sb">&nbsp;</td>
    <td>&nbsp;</td>
    <td width="10%" class="TitTablaC">&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top" class="caja_texto_pe">DNI</td>
    <td class="caja_texto_pe"><input name="dni" type="text" class="caja_texto_pe" id="dni" onkeypress="return justNumbers(event);" maxlength="8" /></td>
  ...
  <tr>
    ...
    <td class="caja_texto_pe"><input name="ape_pat" type="text" class="caja_texto_pe"  id="ape_pat" size="50" maxlength="50" style="text-transform:uppercase;" 
  ...
  <tr>
    ...
    <td class="caja_texto_pe"><input name="ape_mat" type="text" id="ape_mat"  class="caja_texto_pe" size="50" maxlength="50" style="text-transform:uppercase;" 
	value=""  onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>
    <td valign="top" class="TitTablaB">&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    ...
    <td class="caja_texto_pe"><input name="nombre" type="text" class="caja_texto_pe" id="nombre" size="50" maxlength="50" style="text-transform:uppercase;" 
	value=""  onkeyup="javascript:this.value=this.value.toUpperCase();" /></td>
    <td valign="top" class="TitTablaB">&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    ...
    <td width="26%" valign="top" class="caja_texto_pe">CARNET</td>
    <td width="35%" class="caja_texto_pe">
	<select name="t_carnet" class="caja_texto_pe" id="t_carnet" onchange="javascript:mostrar_carnet(this.value)" >
      <option value="0">Seleccione</option>
      <option value="1">CON CARNET</option>
      <option value="2">SIN CARNET</option>
    </select></td>
    <td colspan="2" valign="top">
	<div id="d_concarnet" style="display:none">
	<select id="c_carnet" name="c_carnet" class="caja_texto_pe">
      <option value="0">...</option>
      <option value="AB">COBRA</option>
      <option value="LA">LARI</option>
      <option value="CA">EZENTIS</option>
        </select>
      <input name="n_carnet" type="text" id="n_carnet" onkeypress="return justNumbers(event);" size="8" maxlength="4" class="caja_texto_pe" />
	</div>
	</td>
    </tr>
  ...
  <tr>
	...
	<select name="c_xregion" class="caja_texto_pe" id="c_xregion" onchange="javascript:mostrar_combo(this.value,'c_zonal')">
        <?php 			
			print "<option value='0' selected>Seleccione</option>";
			$c1="select region from ws_zonificacion_cot group by 1";
		  	$rs1 = mysql_query($c1,$connection_w101) or die (mysql_error());
			while ($rg1=mysql_fetch_row($rs1)) { 										  
			print "<option value='$rg1[0]'>$rg1[0]</option>";
			}
			?>
    </select>	</td>
    <td valign="top" class="TitTablaB">&nbsp;</td>
  ...
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top" class="caja_texto_pe"><span class="TitTablaB">ZONAL</span></td>
    <td class="caja_texto_pe"><div id="c_zonal"></div></td>
    <td valign="top">&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top" class="caja_texto_pe"><span class="TitTablaB">CONTRATA</span></td>
    <td class="caja_texto_pe"><div id="c_eecc"></div></td>
    <td valign="top">&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top" class="caja_texto_pe"><span class="TitTablaB">JEFATURA</span></td>
    <td class="caja_texto_pe"><div id="c_jefatura"></div></td>
    <td valign="top">&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    ...
    <td class="caja_texto_pe"><select name="c_gestion" class="caja_texto_pe" id="c_gestion" onchange="javascript:mostrar_carnet(this.value)" >
  ...
  <tr>
    ...
    <td valign="top" class="caja_texto_pe"><select name="c_estado" class="caja_texto_pe" id="c_estado" onchange="javascript:mostrar_carnet(this.value)" >
  ...
  <tr>
    ...
    <td valign="top" class="caja_texto_pe"><textarea name="detalle" cols="50" rows="4" class="caja_texto_pe" id="detalle"></textarea></td>
    <td valign="top" class="TitTablaB">&nbsp;</td>
    <td valign="top">&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top" class="caja_texto_pe">SOLICITADO POR </td>
    <td valign="top" class="caja_texto_pe"><input name="solicitado" type="text" id="solicitado"  size="100" class="caja_texto_pe" /></td>
    <td valign="top" class="TitTablaB">&nbsp;</td>
    <td valign="top">&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">      
      ...
      <tr>
		...
		<table width="31%" border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td class="box-blue">OPCIONES DEL MENU </td>
			<!--<td class='box-blue' align='center'>TODOS<br><input type='checkbox' name='' id=''  /> </td>-->
			<td class='box-blue' align='center'>TODOS
			<br><input type='checkbox' name='checkbox_t' id='checkbox_t'  onclick="javascript:marcaAllCheckBox('1');"  /> </td>
          </tr>
          <tr>
            <td>P_CONSULTA</td>
            <td align="center"><input type="checkbox" name="check_1"  id="check_1" checked="checked" /></td>
          </tr>
          <tr>
            <td>P_RESET</td>
            <td align="center"><input type="checkbox" name="check_2" id="check_2" value="" /></td>
          </tr>
          <tr>
            <td>P_RECONFIG</td>
            <td align="center"><input type="checkbox" name="check_3" id="check_3" value="" /></td>
          </tr>
          <tr>
            <td width="78%">P_CAMBIOPARADSL</td>
            <td width="22%" align="center"><input type="checkbox" name="check_4" id="check_4" value="" /></td>
          </tr>
          <tr>
            <td>P_CAMBIOVOZ</td>
            <td align="center"><input type="checkbox" name="check_5" id="check_5" value="" /></td>
          </tr>
          <tr>
            <td>P_RECOMENLINEA</td>
            <td align="center"><input type="checkbox" name="check_6" id="check_6" value="" /></td>
          </tr>
          <tr>
            <td>P_CONSULTAPEDIDO</td>
            <td align="center"><input type="checkbox" name="check_7" id="check_7" value="" /></td>
          </tr>
          <tr>
            <td>P_REPORTE</td>
            <td align="center"><input type="checkbox" name="check_8" id="check_8" value="" /></td>
          </tr>
          <tr>
            <td>P_REASIGNACION</td>
            <td align="center"><input type="checkbox" name="check_9" id="check_9" value="" /></td>
          </tr>
          <tr>
            <td>P_REGISTRARCAJA</td>
            <td align="center"><input type="checkbox" name="check_10" id="check_10" value="" /></td>
          </tr>
          <tr>
            <td>P_FLAGCONFORMIDAD</td>
            <td align="center"><input type="checkbox" name="check_11" id="check_11" value="" /></td>
          </tr>
          <tr>
            <td>P_REASIG_MDF</td>
            <td align="center"><input type="checkbox" name="check_12" id="check_12" value="" /></td>
          </tr>
          <tr>
            <td>P_OBSERVADAS</td>
            <td align="center"><input type="checkbox" name="check_13" id="check_13" value="" checked="checked" /></td>
          </tr>
          <tr>
            <td>P_REPORTENODEID</td>
            <td align="center"><input type="checkbox" name="check_14" id="check_14" value="" /></td>
          </tr>
          <tr>
            <td>P_CONSULTACAJAS</td>
            <td align="center"><input type="checkbox" name="check_15" id="check_15" value="" /></td>
          </tr>
          <tr>
            <td>P_TRATATECNICO</td>
            <td align="center"><input type="checkbox" name="check_16" id="check_16" value="" checked="checked" /></td>
          </tr>
          <tr>
            <td>P_TRATCONSULTATELF</td>
            <td align="center"><input type="checkbox" name="check_17" id="check_17" value="" checked="checked" /></td>
          </tr>
          <tr>
            <td>P_CIERREATEN</td>
            <td align="center"><input type="checkbox" name="check_18" id="check_18" value="" /></td>
          </tr>
          <tr>
            <td>P_GAMMING</td>
            <td align="center"><input type="checkbox" name="check_19" id="check_19" value="" /></td>
          </tr>
          <tr>
            <td>P_PCGAVERIA</td>
            <td align="center"><input type="checkbox" name="check_20" id="check_20" value="" /></td>
          </tr>
          <tr>
            <td>TOA</td>
            <td align="center"><input type="checkbox" name="check_21" id="check_21" value="" /></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td align="center">&nbsp;</td>
  ...
  <tr>
    <td colspan="5"><div class="boton" id="mensajes_movimientos"></div></td>
  </tr>
</table>
</div>
