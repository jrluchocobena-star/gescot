...
function createRequest() {
	try {
		ajaxc = new ActiveXObject("Msxml2.XMLHTTP");
	} catch (e) {
		try {
...
function salir(idsess, iduser) {
	var pag1 =
		"funciones_cot.php?idsess=" +
		idsess +
		"&iduser=" +
		iduser +
		"&accion=cerrar_secion";
	...
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			...
			window.location = "http://localhost/gescot/login.php";
		}
	};
	ajaxc.send(null);
}
...
function mostrar_datos_contacto(opc) {
	...
	if (
		document.getElementById("usu_contactos").value == "" ||
		document.getElementById("usu_contactos").value == " " ||
		...
		ajaxc.onreadystatechange = function () {
			if (ajaxc.readyState == 4) {
				...
				document.getElementById("div_lista_contactos").innerHTML =
					ajaxc.responseText;
...
function menu(opc) {
	...
	if (iduser == "" || iduser == " " || iduser == "undefined") {
		...
		if (opc == "0") {
			var pag =
				"mantenimiento_usuarios_perfil.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "1") {
			var pag =
				"cab_numero_contactos.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "2") {
			...
			var pag =
				"cab_modulo_asignaciones.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "3") {
			...
			var pag =
				"cargas/select_archivo.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "8") {
			var pag =
				"bandejas/bandeja_general_usuarios.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "9") {
			var pag =
				"cab_modulo_beoliquidaciones.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "10") {
			var pag =
				"registro_modem_averiados.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "13") {
			var pag =
				"modulo_gestion_usuarios_cot.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "15") {
			//var pag="modulo_asignaciones.php?iduser="+iduser+"&idperfil="+idperfil;
			var pag =
				"cab_modulo_asignaciones_v1.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "16") {
			var pag =
				"cab_numero_contactos_tdata.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "17") {
			var pag =
				"BANDEJAS/bandeja_registros_101.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "19") {
			var pag =
				"modulo_mantenimientos.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
		...
		if (opc == "23") {
			var pag =
				"importar_dni/form_cargar_dni.php?iduser=" +
				iduser +
				"&idperfil=" +
				idperfil +
				"&pc=" +
...
function validar_pedido(peticion, fec_reg, iduser, origen, pedido) {
	...
	if (confirm(msn2)) {
		var pag1 =
			"funciones_cot.php?peticion=" +
			peticion +
			"&iduser=" +
			iduser +
			"&accion=validar_pedido";
		//alert(pag1)
...
function openCity(cityName, frame, iduser, opc) {
	...
	if (opc == "3") {
		...
		var pag =
			"bandejas/bandeja_general_asignaciones.php?&iduser=" +
			iduser +
			"&opc=" +
			opc;
	}
...
function menu_asig(opc) {
	...
	if (opc == "4") {
		...
		document.getElementById("fcab_criterios").src =
			"cab_criterios_asi.php?iduser=" + iduser;
...
function contar_pedidos(pedido, iduser) {
	var pag1 =
		"funciones_cot.php?pedido=" +
		pedido +
		"&iduser=" +
		iduser +
		"&accion=contador_pedidos";
...
function conteo_pedidos_operador(iduser) {
	var pag1 =
		"funciones_cot.php?iduser=" + iduser + "&accion=conteo_pedidos_operador";
	...
	if (area == "0" && ncompleto == "" && cip == "" && dni == "") {
		...
		if (cip == "0" && ncompleto == "") {
			if (opcion == "1") {
				...
				var pag1 =
					"mantenimiento_usuarios_edit.php?cip=" +
					cip +
					"&area=" +
					area +
					"&dni=" +
			...
			if (opcion == "2") {
				...
				var pag1 =
					"mantenimiento_usuarios_horiz.php?cip=" +
					cip +
					"&area=" +
					area +
					"&dni=" +
...
function mostrar_datos_usuarios(dni) {
	...
	ajaxc1.onreadystatechange = function () {
		if (ajaxc1.readyState == 4) {
			...
			parent.document.getElementById("d_datos_usuarios").style.display =
				"block";
			parent.document.getElementById("d_datos_usuarios").innerHTML =
				ajaxc1.responseText;
...
function actualizar_datos_usu(dni) {
	...
	var USUARIO_MULTICONSULTA = document.getElementById("USUARIO_MULTICONSULTA")
		.value;
	var USUARIO_INTRAWAY = document.getElementById("USUARIO_INTRAWAY").value;
	var USUARIO_WEB_UNIFICADA = document.getElementById("USUARIO_WEB_UNIFICADA")
		.value;
	...
	var USUARIO_INCIDENCIAS_PSI = document.getElementById(
		"USUARIO_INCIDENCIAS_PSI"
	).value;
	...
	var WEB_ARPU_CALCULADORA = document.getElementById("WEB_ARPU_CALCULADORA")
		.value;
	...
	var pag2 =
		"funciones_cot.php?dni=" +
		dni +
		"&USUARIO_GESTEL=" +
		USUARIO_GESTEL +
		"&USUARIO_MULTICONSULTA=" +
		USUARIO_MULTICONSULTA +
		"&USUARIO_INTRAWAY=" +
		USUARIO_INTRAWAY +
		"&USUARIO_WEB_UNIFICADA=" +
		USUARIO_WEB_UNIFICADA +
		"&USUARIO_PSI=" +
		USUARIO_PSI +
		"&USUARIO_ATIS=" +
...
function actualizar_datos_usu_horiz() {
	...
	if (document.getElementById("motivo_cambio").value == "") {
		alert(
			"OBLIGATORIO: Debe ingresar el motivo de la actualizacion de informacion"
		);
		return;
	} else {
		...
		*/
		var pag2 =
			...
			"&sgrupo=" +
			sgrupo +
			"&accion=actualizar_datos_usu_horiz";
...
function grabar_incidencia(opc) {
	...
	if (document.getElementById("modo").value == "0") {
		...
		if (document.getElementById("modo").value == "D") {
			...
			var h_ini =
				...
				":" +
				document.getElementById("mm_ini").value;
			var h_fin =
				document.getElementById("h_fin").value +
				":" +
				document.getElementById("mm_fin").value;

			var fec1 = fec1.split(" ");
			var fec1x = fec1[0];
			var xfec_ini = fec1x.split("-");
			var xfec_ini =
				xfec_ini[2] + "-" + xfec_ini[1] + "-" + xfec_ini[0] + " " + h_ini;

			var fec2 = fec2.split(" ");
			var fec2x = fec2[0];
			var xfec_fin = fec2x.split("-");
			var xfec_fin =
				xfec_fin[2] + "-" + xfec_fin[1] + "-" + xfec_fin[0] + " " + h_fin;
		}
	}
  ...
  */
	...
	var cri1 = "";
	var cc =
		"bandejas/bandeja_general_incidencias.php?iduser=" +
		iduser +
		"&idperfil=" +
		idperfil +
		"&cri1=" +
...
function mant_incidencia(opc) {
	...
	if (opc == "1") {
		...
		var pag1 =
			"bandeja_incidencias_sup.php?iduser=" + iduser + "&idperfil=" + idperfil;
		//alert(idperfil)
	...
	if (opc == "3") {
		...
		var pag =
			"bandejas/bandeja_incidencias_sup.php?iduser=" +
			iduser +
			"&idperfil=" +
			idperfil;
		//alert(idperfil)
	...
	if (opc == "5") {
		...
		var url =
			"reporte_incidencias.php?iduser=" +
			iduser +
			"&cri2=" +
			cri2 +
			"&cri1=" +
	...
	if (opc == "6") {
		...
		var fec_i =
			document.getElementById("an_i").value +
			"-" +
			document.getElementById("mes_i").value +
			"-" +
			document.getElementById("dia_i").value;
		var fec_f =
			document.getElementById("an_f").value +
			"-" +
			document.getElementById("mes_f").value +
			"-" +
			document.getElementById("dia_f").value;

		var cri2 = document.getElementById("c_monitor").value;

		var url =
			"reporte_capacitaciones.php?iduser=" +
			iduser +
			"&cri2=" +
			cri2 +
			"&fec_i=" +
	...
	if (opc == "8") {
		...
		var pag =
			"bandeja_incidencias_capa.php?iduser=" +
			iduser +
			"&cip=" +
			cip +
			"&supervisor=" +
...
function listar_tecnicos() {
	...
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			//alert(ajaxc.responseText)
			document.getElementById("d_lista_tecnicos").innerHTML =
				ajaxc.responseText;
...
function mostrar_edicion(dni) {
	...
	var pag =
		"mantenimiento_usuarios_edit.php?iduser=" +
		iduser +
		"&dni=" +
		dni +
		"&idperfil=" +
...
function cambio_contra(iduser) {
	...
	var url =
		"funciones_cot.php?contra1=" +
		contra1 +
		"&iduser=" +
		iduser +
		"&accion=cambio_contra";
	//alert(url)
...
function historico_contactos() {
	...
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			...
			document.getElementById("d_historico_contactos").innerHTML =
				ajaxc.responseText;
...
function reporte_general() {
  ...
  */
	...
	if (xreporte == "423") {
		var url =
			"reporte_gestel_423_criterio.php?iduser=" +
			iduser +
			"&xmes=" +
			xmes +
			"&xano=" +
	...
	if (xreporte == "423P") {
		var url =
			"reporte_gestel_423_criterio_prov.php?iduser=" +
			iduser +
			"&xmes=" +
			xmes +
			"&xano=" +
	...
	if (xreporte == "47D") {
		var url =
			"reporte_gestel_47D_criterios.php?iduser=" +
			iduser +
			"&xmes=" +
			xmes +
			"&xano=" +
	...
	if (xreporte == "CONSULTAS_CONTACTOS") {
		var url =
			"../reportes_consulta_contactos.php?iduser=" +
			iduser +
			"&xmes=" +
			xmes +
			"&xano=" +
	...
	if (xreporte == "INCIDENCIAS COT") {
		var url =
			"reporte_incidencias_nuevo_mes.php?iduser=" +
			iduser +
			"&xmes=" +
			xmes +
			"&xano=" +
	...
	if (xreporte == "HORAS PROGRAMADAS") {
		var url =
			"reportes_prog_extras.php?iduser=" +
			iduser +
			"&xmes=" +
			xmes +
			"&xano=" +
	...
	if (xreporte == "CAPACITACION") {
		var url =
			"reporte_capacitacion_pormes.php?iduser=" +
			iduser +
			"&xmes=" +
			xmes +
			"&xano=" +
...
function popup_reclamo(tipo, val1, val2, val3, val4, val5) {
	if (tipo == 1) {
		...
		ras = dhtmlmodal.open(
			...
			page,
			"Detalle",
			"top=20,left=500,width=600px,height=360px,center=0,resize=0,scrolling=0"
		);
	}
	...
	if (tipo == 3) {
		...
		var page =
			"cab_registro_incidenciascot_n1.php?iduser=" +
			val1 +
			"&idperfil=" +
			val2 +
			"&accion=" +
	...
	if (tipo == 4) {
		...
		var page =
			"../incidencias_mod_gestion.php?iduser=" +
			val1 +
			"&idperfil=" +
			val2 +
			"&accion=" +
		...
		ras = dhtmlmodal.open(
			...
			"iframe",
			page,
			"Editar Incidencias COT",
			"width=500px,height=300px,center=30,resize=0,scrolling=0"
		);
	}
	...
	if (tipo == 5) {
		...
		ras = dhtmlmodal.open(
			...
			page,
			"Detalle",
			"width=550px,height=300px,center=1,resize=0,scrolling=0"
		);
	}
	...
	if (tipo == 6) {
		...
		ras = dhtmlmodal.open(
			...
			page,
			"BEO LIQUIDACION",
			"width=730px,height=500px,top=20,left=400,resize=0,scrolling=0"
		);

		/******************/

		aceptar_asignacion_bl(
			c_multig,
			c_cliente,
			iduser,
			fec_cli,
	...
	if (tipo == 7) {
		...
		ras = dhtmlmodal.open(
			...
			page,
			"Detalle",
			"width=550px,height=300px,top=20,left=400,resize=0,scrolling=0"
		);
	}
	...
	if (tipo == 8) {
		...
		var page =
			"bandejas/lista_capacitacion.php?c_multig=" +
			val1 +
			"&iduser=" +
			val2 +
			"&tipo=" +
		...
		ras = dhtmlmodal.open(
			...
			page,
			"Detalle",
			"width=1200px,height=500px,top=20,left=100,resize=0,scrolling=0"
		);
	}
	...
	if (tipo == 9) {
		...
		var page =
			"panel_asignaciones.php?c_multig=" +
			val1 +
			"&iduser=" +
			val2 +
			"&tipo=" +
	...
	if (tipo == 10) {
		...
		ras = dhtmlmodal.open(
			...
			page,
			"Detalle",
			"width=1300px,height=600px,top=20,left=10,resize=0,scrolling=0"
		);
	}
	...
	if (tipo == 11) {
		...
		ras = dhtmlmodal.open(
			...
			page,
			"F_MIGRACIONES",
			"top=20,left=500,width=600px,height=450px,center=0,resize=0,scrolling=0"
		);
	}
	...
	if (tipo == 12) {
		...
		var page =
			"cab_registro_incidenciascot.php?iduser=" +
			val1 +
			"&idperfil=" +
			val2 +
			"&accion=" +
...
function cerrar_win(opc) {
	...
	if (opc == "1") {
		...
		rechazar_pedido(
			...
			pedido,
			iduser,
			"RECHAZO DESPUES DE ACEPTAR EL PEDIDO"
		);
		parent.ras.hide();
	}
...
function listar_bandeja_asignaciones_pend(opc, iduser, idperfil) {
	...
	if (opc == "2") {
		var pag2 =
			"bandejas/bandeja_general_asignaciones_pend.php?iduser=" +
			iduser +
			"&idperfil=" +
			idperfil;
	}
	...
	if (document.getElementById("usu_contactos").value == "") {
		...
		if (
			...
			document.getElementById("barra_cargando").innerHTML =
				"<img src=\"loading3.gif\" width='300' height='200' />";
			document.getElementById("div_lista_contactos").style.display = "none";
...
function mostrar_pedido() {
	...
	var url =
		"modulo_asignaciones.php?iduser=" +
		iduser +
		"&idperfil=" +
		idperfil +
		"&origen=" +
...
function calcular_tiempos() {
	...
	if (
		document.getElementById("modo").value == "D" ||
		document.getElementById("modo").value == "0"
	) {
		if (
			document.getElementById("input1").value == "" ||
...
function mostrar_bandejas_incidencias(opc) {
	...
	if (opc == "2") {
		...
		var pag =
			"bandejas/bandeja_general_capacitaciones.php?iduser=" +
			iduser +
			"&cri2=" +
			cri2 +
			"&fec_i=" +
...
function mostrar_datos_carga(origen) {
	//alert(origen)
	document.getElementById("sw_G47D").value =
		document.getElementById("sw_G47D").value - 1;
	document.getElementById("sw_G423").value =
	...
	var pag4 =
		"funciones_cot.php?origen=" + origen + "&accion=mostrar_datos_carga";
	//alert(pag4)
	ajaxc = createRequest();
	ajaxc.open("get", pag4, true);
	ajaxc.onreadystatechange = function () {
...
function mostrar_pedido_bl() {
	...
	var url =
		"modulo_beoliquidaciones.php?iduser=" +
		iduser +
		"&idperfil=" +
		idperfil +
		"&tiempo=" +
...
function listar_bandeja_asignaciones_pend_bl(opc, iduser, idperfil) {
	...
	if (opc == "2") {
		var pag2 =
			"bandejas/bandeja_general_beoliquidaciones_pend.php?iduser=" + iduser;
	}
	if (opc == "3") {
	...
	document.getElementById("i_bandeja_asignaciones").src = "";
	document.getElementById("bandeja_asignaciones").style.display = "block";
	document.getElementById("i_bandeja_asignaciones").style.visibility =
		"visible";
	document.getElementById("i_bandeja_asignaciones").src = pag2;
}

function aceptar_asignacion_bl(
	c_multig,
	iduser,
	fec_cli,
	fec_atento,
	...
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			...
			if (ajaxc.responseText == 1) {
				...
				document.getElementById("d_detalle_pedidos_decos").style.display =
					"block";
				document.getElementById("d_bandeja_pedidos_decos").style.display =
					"none";
			} else {
				...
				document.getElementById("d_bandeja_pedidos_decos").style.display =
					"block";
				document.getElementById("d_bandeja_pedidos_decos").innerHTML =
					ajaxc.responseText;
			}
...
function bandeja_modem_ave() {
	...
	var pag =
		"bandejas/bandeja_pedidos_modem_ave.php?iduser=" +
		iduser +
		"&idperfil=" +
		idperfil;
	//alert(pag)
...
function escojer_gestor() {
	...
	for (i = 1; i < 10000; i++) {
		...
		if (document.getElementById(cor).checked) {
			...
			document.getElementById("chk_escogidos_").value =
				"Escogidos : " + con + " elementos  ";
...
function ventana_modal(opcion) {
	...
	if (opcion == 1) {
		...
		var page =
			"bandejas/lista_capacitacion.php?iduser=" + iduser + "&c_inc=" + c_inc;
		var atributos =
			"width=950px,height=400px,top=60px,left=10px,center=0,resize=0,scrolling=0";
	...
	if (opcion == 2) {
		...
		var atributos =
			"width=1300px,height=500px,top=60px,left=10px,center=0,resize=0,scrolling=0";
		var titulo = "LISTADO DE GESTORES COT";
		//alert(page);
	}
	...
	if (opcion == 3) {
		...
		var atributos =
			"width=1500px,height=500px,top=60px,left=10px,center=0,resize=0,scrolling=0";
	...
	if (opcion == 4) {
		...
		var page =
			"gestion_maestra_cot.php?dni=" + dni + "&iduser=" + iduser + "&caso=3";
		var atributos =
			"width=1000px,height=500px,top=60px,left=10px,center=0,resize=0,scrolling=0";
	...
	if (opcion == 5) {
		...
		var page =
			"gestion_maestra_cot.php?dni=" + dni + "&iduser=" + iduser + "&caso=2";
		var atributos =
			"width=1000px,height=500px,top=60px,left=10px,center=0,resize=0,scrolling=0";
	...
	if (opcion == 6) {
		...
		var page =
			"gestion_maestra_cot.php?dni=" + dni + "&iduser=" + iduser + "&caso=4";
		var atributos =
			"width=1500px,height=700px,top=20px,left=50px,center=0,resize=0,scrolling=0";
		var titulo = "HISTORICO DE USUARIOS MAESTRA COT";
		//alert(page);
	}
	...
	if (opcion == 7) {
		var page =
			"bandeja_aprobaciones_cot_supervisores.php?iduser=" +
			iduser +
			"&idperfil=" +
			idperfil;
		var atributos =
	...
	if (opcion == 9) {
		...
		var atributos = "width=1300px,height=700px,center=0,resize=0,scrolling=0";
	...
	if (nro_escogidos < 0) {
		...
		ajaxc.onreadystatechange = function () {
			if (ajaxc.readyState == 4) {
				...
				document.getElementById("c_incx").value = document.getElementById(
					"c_inc"
				).value;
				parent.modal.hide();
			}
...
function grabar_incidencia_prueba(opc) {
	...
	if (document.getElementById("modo").value == "0") {
		...
		if (document.getElementById("modo").value == "D") { //ki
			var fec1 = document.getElementById("input1").value;
			var fec2 = document.getElementById("input2").value;
	...
	var pag1 =
		...
		"&obs=" +
		obs +
		"&accion=grabar_incidencia_prueba";
...
function buscar_gestores_asig() {
	...
	var urlx =
		"funciones_cot.php?c_supervisor=" +
		c_supervisor +
		"&gestores=" +
		gestores +
		"&fec=" +
	...
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			//alert(ajaxc.responseText);
			document.getElementById("div_bandeja_asignaciones").innerHTML =
				ajaxc.responseText;
		}
	};
	ajaxc.send(null);
...
function mostrar_frame_gu() {
	...
	var pag_gu =
		"bandejas/bandeja_seguimiento_gu.php?iduser=" +
		iduser +
		"&idperfil=" +
		idperfil;
...
function ver_div_incidencias() {
	...
	if (idperfil != 1) {
		...
		var supervisor = "";
		var gestor = "";
		var u_reg = document.getElementById("iduser").value;
	}
...
function ver_incidencia(c0, c1, c2, c3, c4, c5, c6, c7, c8, c9) {
	...
	parent.document.getElementById("div_editar_incidencia").style.display =
		"block";
...
function grabar_edicion_incidencia() {
	...
	var pagx1 =
		...
		"&obs=" +
		obs +
		"&accion=grabar_edicion_incidencia";
...
function eliminar_incidencia(c_inc, inc, xdni) {
	...
	var msn2 =
		"Desea Eliminar la incidencia " + inc + " para el dni " + xdni + " ?";
	if (confirm(msn2)) {
		//alert(urlx)
		ajaxc = createRequest();
		ajaxc.open("GET", urlx, true);
...
function reporte_inc(opc) {
	...
	if (opc == "1") {
		var url =
			"exportar_incidencias.php?iduser=" +
			iduser +
			"&idperfil=" +
			idperfil +
			"&u_reg=" +
...
function MIexcel() {
	...
	if (IEx == 1) {
		...
		var excBook = ExcelAp.Workbooks.open(
			"D:/COMPARTIDO/DATA/DEVUELTAS/out/INC_PROB.xls"
		);
		...
		//Crear un complemento para firefox
...
function visualizar_parametros(valor) {
	...
	if (valor == "ASIGNACIONES") {
		document.getElementById("d_parametros_asignaciones").style.display =
			"block";
		document.getElementById("d_parametros_cancelaciones").style.display =
			"none";
...
function visualizar_pedido_v1(actividad) {
	...
	var url =
		"modulo_asignaciones_v1.php?iduser=" +
		iduser +
		"&idperfil=" +
		idperfil +
		"&combo1=" +
...
function aceptar_pedido_canceladas(id) {
	...
	if (document.getElementById("c_tipo").value == "") {
		...
		var pag =
			...
			"&iduser=" +
			iduser +
			"&accion=aceptar_pedido_canceladas";
...
function buscar_contacto_tdata() {
	...
	var d = new Date();
	document.getElementById("timpo").value =
...
function mostrar_datos_contacto_tdata(opc) {
	...
	if (
		...
		var pag1 =
			"detalle_num_contacto_tdata.php?dni=" +
			dni +
			"&opc=" +
			opc +
			"&pedido=" +
...
function validar_pedido_migracion(peticion, fec_reg, iduser, origen, pedido) {
	...
	if (confirm(msn2)) {
		var pag1 =
			...
			"&iduser=" +
			iduser +
			"&accion=validar_pedido_migracion";
		//alert(pag1)
...
function rechazar_pedido_migracion(peticion, iduser, obs) {
	var pag1 =
		...
		"&iduser=" +
		iduser +
		"&accion=rechazar_pedido_migracion";
	//alert(pag1)
	ajaxc = createRequest();
	ajaxc.open("get", pag1, true);
	ajaxc.onreadystatechange = function () {
...
function guardar_arch(tipo) {
	...
	var pag =
		"ws_subir_archivo.php?archivo_origen=" +
		archivo_origen +
		"&carpeta_destino=" +
		carpeta_destino;
...
function grabar_movimientos_usuarios() {
	...
	if (
		document.getElementById("an_i").value == "0000" ||
		document.getElementById("dia_i").value == "00"
	) {
		...
		if (xusu_mov == "" || xusu_mov == "-" || xusu_mov == "X") {
			...
			ajax.onreadystatechange = function () {
				if (ajax.readyState == 4) {
					...
					//document.getElementById("datos_planta").innerHTML = resx;
					alert(resx);
					document.getElementById("div_edicion_usuarios").style.display =
						"NONE";
					//parent.ras.hide();
					parent.ras.reload();
				}
...
function mostrar_registro_incidenciacot(valor) {
	...
	if (valor == "2") {
		...
		document.getElementById("div_registro_individual").style.display = "none";
	...
	if (valor == "5") {
		document.getElementById("div_registro_individual").style.display = "block";
		document.getElementById("registro_gestores").style.display = "block";
		document.getElementById("lista_participantes").style.display = "none";
		document.getElementById("div_modulo_masivo").style.display = "none";
		document.getElementById("div_modulo_masivo_excel").style.display = "none";
...
function mostrar_modo_gru(valor_c) {
	...
	if (document.getElementById("min_acu").value>360){
		document.getElementById("bt_aceptar_gru").style.display = "none";
		document.getElementById("alerta_tiempo").value	 = "Minutos acumulados exceden a las 360 min. por dia";
	}else{
		document.getElementById("bt_aceptar_gru").style.display = "block";
		document.getElementById("alerta_tiempo").value	 = "";
	}
}
...
function calcular_tiempos_gru() {
	...
	if (document.getElementById("modo_gru").value == "0") {
		...
		if (modo == "H") {
			...
			var hor_ini =
				document.getElementById("h_ini_gru").value +
				":" +
				document.getElementById("mm_ini_gru").value;
			var hor_fin =
				document.getElementById("h_fin_gru").value +
				":" +
				document.getElementById("mm_fin_gru").value;
			document.getElementById("exc_gru").value = "HH:MM";
		}
	}

	if (
		document.getElementById("modo_gru").value == "D" ||
		document.getElementById("modo_gru").value == "0"
	) {
		if (
			document.getElementById("inputg1").value == "" ||
...
function grabar_incidencia_grupal() {
	...
	if (nro_escogidos == "") {
		...
		if (
			document.getElementById("c_incidencia").value == "" ||
			document.getElementById("c_incidencia").value == "INC-1"
		) {
			alert(
				"EL CODIGO DE INCIDENCIA ESTA VACIO O TIENE UN DATO ERRONEO(INC-1)"
			);
			return;
		} else {
			if (document.getElementById("modo_gru").value == "0") {
			...
			var pag =
				...
				"&nro_escogidos=" +
				nro_escogidos +
				"&accion=grabar_incidencia_grupal";
			alert(pag);
			...
			ajaxc.onreadystatechange = function () {
				if (ajaxc.readyState == 4) {
					...
					document.getElementById("d_horario_gestor").innerHTML =
						ajaxc.responseText;
...
function calcular_tiempos_mas() {
	...
	if (document.getElementById("modo_mas").value == "0") {
		...
		if (modo == "H") {
			...
			var hor_ini =
				document.getElementById("h_ini_mas").value +
				":" +
				document.getElementById("mm_ini_mas").value;
			var hor_fin =
				document.getElementById("h_fin_mas").value +
				":" +
				document.getElementById("mm_fin_mas").value;
			document.getElementById("exc_mas").value = "HH:MM";
		}
	}

	if (
		document.getElementById("modo_mas").value == "D" ||
		document.getElementById("modo_mas").value == "0"
	) {
		if (
			document.getElementById("inputm1").value == "" ||
		...
		if (
			...
			document.getElementById("h_ini_mas").value == "0" ||
			document.getElementById("h_fin_mas").value == "0"
		) {
			document.getElementById("bt_grabar_mas").style.display = "none";
			alert("ERROR: NO HA INGRESADO HORAS COMPLETAS");
			return;
...
function grabar_incidencia_masiva() {
	...
	if (document.getElementById("modo_mas").value == "0") {
		...
		var pag =
			...
			"&nro_escogidos=" +
			nro_escogidos +
			"&accion=grabar_incidencia_masiva_nuevo";
		//alert(pag)
...
function mostrar_bandeja_gestores(valor) {
	...
	ajaxp.onreadystatechange = function () {
		if (ajaxp.readyState == 4) {
			...
			document.getElementById("d_bandeja_gestores_cot").innerHTML =
				ajaxp.responseText;
...
function soloLetras(e) {
	...
	for (var i in especiales) {
		...
		if ((key > 47 && key < 58) || key == 8 || key == 13 || key == 6) {
			// SOLO NUMEROS
			return true;
		}
	}
...
function mostrar_horarios_gestores() {
	...
	var pag1 =
		"funciones_cot.php?hor_gestores=" +
		hor_gestores +
		"&nro_escogidos=" +
		nro_escogidos +
		"&accion=mostrar_horarios_gestores";
	//alert(pag1)
...
function validar_horarios_gestores() {
	...
	if (document.getElementById("chk_escogidos").value == "") {
		...
		if (
			...
			alert(
				"Error: EL CODIGO DE INCIDENCIA ESTA VACIO O TIENE UN DATO ERRONEO(INC-1)"
			);
			return;
		} else {
				...
				if (fec1 == "" && fec2 == "") {
					...
					if (fec1 == "" || fec2 == "") {
						...
						if (fec1 > fec2) {
							...
							var xfec_ini = fec1x.split("-");
							var xfec_ini =
								xfec_ini[2] + "-" + xfec_ini[1] + "-" + xfec_ini[0];

							var fec2 = fec2.split(" ");
							var fec2x = fec2[0];
							var xfec_fin = fec2x.split("-");
							var xfec_fin =
								xfec_fin[2] + "-" + xfec_fin[1] + "-" + xfec_fin[0];
						}
					}
				}
			} else {
...
function validar_horarios_incidencias() {
	...
	var pag_val =
		"funciones_cot.php?dni_escogidos=" +
		dni_escogidos +
		"&modo_gru=" +
		modo_gru +
		"&arr_hor=" +
...
function msn_alerta(modulo, valor_1, valor_2) {
	if (modulo == "1") {
		...
		var p_modulo =
			...
			estado;
		//alert(p_modulo);
		alerta = dhtmlmodal.open(
			"EmailBox",
			"iframe",
			p_modulo,
			"INCIDENCIAS COT",
			"top=30,left=200,width=600px,height=360px,center=1,resize=0,scrolling=0"
		);
	}
}
...
function carga_combo_modo(nom_combo, valor1) {
	...
	var urlx =
		"funciones_cot.php?valor_combo=" +
		valor_combo +
		"&combo=" +
		nom_combo +
		"&accion=carga_combo_modo";
	//alert(urlx)
...
function mostrar_bandeja_incidencias(valor) {
	var pag =
		"funciones_cot.php?valor=" + valor + "&accion=listar_bandeja_incidencias";
	...
	ajaxp.onreadystatechange = function () {
		if (ajaxp.readyState == 4) {
			var resp1 = ajaxp.responseText;
			document.getElementById("d_bandeja_incidencias_cot").style.display =
				"block";
			document.getElementById("d_bandeja_incidencias_cot").innerHTML =
				ajaxp.responseText;
			document.getElementById("add_gestores").style.display = "block";
		}
	};
...
function aprobar_incidencias_sup(estado) {
	...
	var idperfil = document.getElementById("idperfil").value;
    if (estado>1){
        var c_rechazados = document.getElementById("c_rechazados").value;
    }else{
       var c_rechazados = "";
    }
	...
	var pag_apro =
		...
		ajaxp = createRequest();
		ajaxp.open("GET", pag_apro, true);
		ajaxp.onreadystatechange = function () {
			if (ajaxp.readyState == 4) {
				var resp_apro = ajaxp.responseText;
				//alert(resp_apro)	
                if (estado>1){
                    document.getElementById("div_noaprobados").style.display = "none";	
                }
...
function motivoRechazoIncidencia(inc_escogidas, nro_escogidos, iduser, idperfil,estado) {
	let incescogidas= inc_escogidas;
	let nroescogidos= nro_escogidos;
	let usuarioid= iduser;
	let perfilid= idperfil;
	let estado_ = estado;
	Swal.fire({
		title: 'MOTIVO DE RECHAZO',
		html: `
		  <textarea id="motivo" class="swal2-textarea" placeholder="Escribe un motivo..."></textarea>
		`,
		...
		if (result.isConfirmed) {
			console.log('Aceptado con motivo:', motivo);
			var pag =
				"funciones_cot.php?iduser=" +
				usuarioid +
				"&inc_escogidas=" +
...
function grabar_incidencias_cot() {
	...
	if (document.getElementById("tp_incidencia").value == "PERMISO") {
		if (document.getElementById("modalidad").value == "D") {
			...
			var fec_ini_comp =
				xfec_i_comp[2] + "-" + xfec_i_comp[1] + "-" + xfec_i_comp[0];

			var fec_f_c = fec_f_c.split(" ");
			var fec_f_c = fec_f_c[0];
			var xfec_f_comp = fec_f_c.split("-");
			var fec_fin_comp =
				xfec_f_comp[2] + "-" + xfec_f_comp[1] + "-" + xfec_f_comp[0];
		} else {
			var fec_c = document.getElementById("input_h_c").value;
			var h_ini =
				document.getElementById("h_ini_comp").value +
				":" +
				document.getElementById("mm_ini_comp").value;
			var h_fin =
				document.getElementById("h_fin_comp").value +
				":" +
				document.getElementById("mm_fin_comp").value;

			var fec_c = fec_c.split(" ");
			var fec_c = fec_c[0];
			var xfec_comp = fec_c.split("-");
			var fec_comp =
				xfec_comp[2] + "-" + xfec_comp[1] + "-" + xfec_comp[0] + " " + h_ini;
		}
	}
...
function agregar_gestores_inc() {
	...
	if (document.getElementById("arr_escogidos").value == "") {
		...
		document.getElementById("lista_participantes").style.display = "none";
		document.getElementById("registro_gestores").style.display = "block";
		muestra_horarios_gestor('1');	
		//listar_incidencias_cot(dni_escogidos);
...
function mostrar_bandeja_aprobaciones() {
	...
	/*
	if (document.getElementById("cb_supervisor").value == "0") {
	...
	*/
	...
	var pag =
		...
		"&gestor=" +
		gestor +
		"&accion=mostrar_bandeja_aprobaciones";
...
function mostrar_bt(valor,perfil) {
	...
	if (valor == "0") {
		...
		document.getElementById("bt_aprobar").style.display = "BLOCK";
		document.getElementById("bt_rechazar").style.display = "BLOCK";
		document.getElementById("bt_cancelar").style.display = "BLOCK";
	}
}
...
function grabar_actualizacion_maestra() {
	var iduser = document.getElementById("iduser").value;
	var dni = document.getElementById("n_dni").value;
	var t_usuario_arpu_calculadora = document.getElementById(
		"t_usuario_arpu_calculadora"
	).value;
	var t_usuario_atis = document.getElementById("t_usuario_atis").value;
	var t_usuario_clear_view = document.getElementById("t_usuario_clear_view")
		.value;
	...
	var t_usuario_incidencias_psi = document.getElementById(
		"t_usuario_incidencias_psi"
	).value;
	var t_usuario_intraway = document.getElementById("t_usuario_intraway").value;
	var t_usuario_multiconsulta = document.getElementById(
		"t_usuario_multiconsulta"
	).value;
	...
	var t_usuario_web_aseguramiento = document.getElementById(
		"t_usuario_web_aseguramiento"
	).value;
	var t_usuario_web_asignaciones = document.getElementById(
		"t_usuario_web_asignaciones"
	).value;
	var t_usuario_web_sara = document.getElementById("t_usuario_web_sara").value;
	var t_usuario_web_sigtp_mapa_gig = document.getElementById(
		"t_usuario_web_sigtp_mapa_gig"
	).value;
	var t_usuario_web_unificada = document.getElementById(
		"t_usuario_web_unificada"
	).value;
...
function grabar_incidencias_cot_nuevo() {
	...
	const hinicio = document.getElementById('h_ini_gru').value;
	const minicio = document.getElementById('mm_ini_gru').value;
	const hfinal = document.getElementById('h_fin_gru').value;
	const mfinal = document.getElementById('mm_fin_gru').value;
	const modalidad= document.getElementById('modalidad').value;

	/*  13.10.2025 */
    /*
	if(modalidad!='D') {
		if (!validarRangoSemana()) {
			console.log('error');
			return;
		}
		if (!validarMinutosIncidencia(hinicio, minicio, hfinal, mfinal)) {
			console.log('error');
			return;
		}
	}
    */
	...
	//alert("HINI="+hinio+", MINI="+minicio+", HFIN="+hfinal+", MFIN="+mfinal);
	//return;
    
    
    //funcion nueva
	if (!validarHorarioGestorIncidencia(hinicio, minicio, hfinal, mfinal)) {
		console.log('error');
		//alert("Error");
		return;
	}
	...
	var limite_min = parseInt(document.getElementById("tiempo_minutos").value)+parseInt(document.getElementById("min_acu").value);
	
	//alert(limite_min);
	
	if(limite_min > 360){
		alert("Aviso: No se puede registrar incidencia, porque excede los 360 minutos permitido por dia")
		return
	}
		...
		if (document.getElementById("tp_incidencia").value == "0") {
			...
			if (document.getElementById("modalidad").value == "0") {
				...
				if (document.getElementById("modalidad").value == "D") {
					...
					if (document.getElementById("combo_mot").value == "41") {
						var h_ini =
							document.getElementById("h_ini_gru_lac").value +
							":" +
							document.getElementById("mm_ini_gru_lac").value;
						var h_fin =
							document.getElementById("h_fin_gru_lac").value +
							":" +
							document.getElementById("mm_fin_gru_lac").value;
					}
				...
				var pag_val =
					...
					"&idperfil=" +
					idperfil +
					"&accion=grabar_incidencias_cot_oficial";
				...
				ajaxc_val.onreadystatechange = function () {
					if (ajaxc_val.readyState == 4) {
						...
						//alert(ajaxc_val.responseText);  //descomentari
						...
						if (error == "2") {
							...
							*/
							var m_correlativo = "Se genero la Incidencia: " + c_incidencia;
							alert(m_correlativo)
							listar_incidencias_cot(dni_escogidos)
                            //cerrar_win('2');
						}
...
function listar_compensaciones_inc() {
	...
	var pag1 =
		"funciones_cot.php?c_incidencia=" +
		c_incidencia +
		"&iduser=" +
		iduser +
		"&accion=" +
	...
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			//alert(ajaxc.responseText)
			document.getElementById("d_listado_compensaciones").innerHTML =
				ajaxc.responseText;
			document.getElementById("d_listado_compensaciones").style.display =
				"block";
		}
	};
	ajaxc.send(null);
...
function save_compensaciones_inc() {
	...
	if (fec_ini_comp < fec_ini_inc) {
		alert(
			"Alerta: Las fechas de Compensaciones deben ser mayor que la fecha de permiso"
		);
		return;
	} else {
		if (
			document.getElementById("tt_acu_comp").value >
			document.getElementById("tt_acumulado").value &&
			...
			if (
				document.getElementById("tt_comp_tot").value >=
				document.getElementById("tt_acumulado").value
			) {
				...
				var pag5 =
					...
					"&motivo_inc=" +
					motivo_inc +
					"&accion=save_compensaciones_inc";
				...
				ajaxcc.onreadystatechange = function () {
					if (ajaxcc.readyState == 4) {
						...
						if (
							...
							document.getElementById("bt_compensacion").style.display =
								"block";
						}
						/*
...
function calc_lactancia() {
	...
	if (document.getElementById("combo_mot").value == "41") {
		var pag1 =
			"funciones_cot.php?fec_ini_lac=" + fec_ini_lac + "&accion=" + accion;
		alert(pag1);
		ajaxc = createRequest();
		ajaxc.open("get", pag1, true);
		ajaxc.onreadystatechange = function () {
...
function grabar_movimientos_usuarios_nuevo(
	id,
	usuario,
	fec_ini,
	dni,
		...
		if (document.getElementById(usuario).value == "") {
			...
			if (document.getElementById(n_xfec_ini).value == "0000-00-00") {
				...
				var page =
					...
					"&n_apli=" +
					n_apli +
					"&accion=grabar_movimientos_usuarios_nuevo";
...
function validarRangoSemana() {
	//const rango_horario = document.querySelector('.r_dias')?.textContent.trim();
	const rango_horario = document.getElementById('rango_dias').value;
	const fecha_selected = document.getElementById('inputg3').value;
	const flagvalidar = document.getElementById('flag_validacion_jornada');
	let isValid = true;

	/* cobe*/
	//alert(rango_horario);

	console.log(rango_horario, fecha_selected);

	if (fecha_selected !== "" && fecha_selected !== null && rango_horario?.length === 7) {
		const [dia, mes, anio] = fecha_selected.split('-').map(Number);
		const fecha = new Date(anio, mes - 1, dia);
		let diaIndex = fecha.getDay();
		diaIndex = (diaIndex === 0) ? 6 : diaIndex - 1;
		if (rango_horario.charAt(diaIndex) === '1') {
			document.getElementById("bt_aceptar_gru").style.display		= "block";
			flagvalidar.innerHTML = "";
			isValid = true;
			return isValid;
		} else {
			
			document.getElementById("bt_aceptar_gru").style.display		= "none";
			flagvalidar.innerHTML = "Error: el DIA DE LA FECHA seleccionada no esta dentro de la semana laboral.";
			isValid = false;
			return isValid;
...
function obtenerMinutosHVi() {

	const fecha = new Date();
	
	const mes = (fecha.getMonth() + 1).toString().padStart(2, '0');
	const h_verano = ["01", "02", "03", "04"];
	let minutos = 0;

	if (h_verano.includes(mes)) {
		minutos = 310;
	} else {
		minutos = 360;
	}
...
function validarHorarioGestorIncidencia(horainicio, minutoinicio, horafin, minutofin) {
	const hentrada = `${horainicio}:${minutoinicio}`;
	const hsalida = `${horafin}:${minutofin}`;
	
	/* cobe */
	//alert("validarHorarioGestorIncidencia");
	//alert("horainicio="+hentrada+", minutoinicio="+minutoinicio);
	//alert("hsahorafinlida="+horafin+", minutofin="+minutofin);


	//const hentradareq = document.querySelector('.h_entrada')?.textContent.trim();
	//const hsalidareq = document.querySelector('.h_salida')?.textContent.trim();
    
    //var hentradareq = horainicio+":"+minutoinicio;
    //var hsalidareq = horafin+":"+minutofin;

	var hentradareq = document.getElementById("rango_horaIniX").value;
	var hsalidareq = document.getElementById("rango_horaFinX").value;

	// randu
	//alert("hentradareq="+hentradareq);
	//alert("hsalidareq="+hsalidareq);
	...
	if (!hentradareq || !hsalidareq) {
		errores.push({
			error: true,
			mensaje: "Error: No se pudieron obtener las horas requeridas.",
			codeError: 0
		});
		return errores;
	}
	...
	const entradaMin = obtenerMinutos(hentrada);
	const salidaMin = obtenerMinutos(hsalida);
	const entradaReqMin = obtenerMinutos(hentradareq);
	const salidaReqMin = obtenerMinutos(hsalidareq);

	//alert("Horario Persona\n hentradareq="+hentradareq+" ("+entradaReqMin+"), hsalidareq="+hsalidareq+" ("+salidaReqMin+")");
	//alert("Horario Elegido\n hentrada="+hentrada+" ("+entradaMin+"), hsalida="+hsalida+" ("+salidaMin+")");

    //alert("hor.sal="+salidaMin+", horario sal="+salidaReqMin);
	


	/* SERGIO CORRECCION PARA QUE 00:00 HORAS NO SEA CERO */
	if (salidaReqMin==0) {
		salidaReqMin2 = 24*60;
		//alert("Horario salida "+salidaReqMin+", convertido a 24:00 = "+salidaReqMin2);
		//salidaReqMin = salidaReqMin2;
	}
	else{
		salidaReqMin2 = salidaReqMin;
	}
	/* FIN SERGIO */

	//alert("entradaMin="+entradaMin+", entradaReqMin="+entradaReqMin+", salidaMin="+salidaMin+", salidaReqMin2="+salidaReqMin2);

	/* Ejemplo: 
	entradaMin = 780 = 13:00 horas
	entradaReqMin = 930 = 15:30 horas
	salidaReqMin = 0 = 00:00 horas

	*/

    if (entradaMin < entradaReqMin) {
	
		errores.push({
			error: true,
			mensaje: "Error: La hora de ENTRADA esta fuera del rango permitido.",
			codeError: 1
		});
	...
	/* Ejemplo: 
	salidaMin = 1140 = 19:00 horas
	salidaReqMin2 = 1440 = 00:00 horas
	*/
	else if (salidaMin > salidaReqMin2) {
		errores.push({
			error: true,
			mensaje: "Error: La hora de SaliDA esta fuera del rango permitido.",
			codeError: 2
		});
...
function validarMinutosIncidencia(horainicio, minutoinicio, horafin, minutofin) {

	const hentrada = parseInt(horainicio);
	const minentrada = parseInt(minutoinicio);
	const hsalida = parseInt(horafin);
	const minsalida = parseInt(minutofin);
	const flagvalidar = document.getElementById('flag_validacion_horas');
	let isValid = true;
	flagvalidar.textContent = "";

	if (horainicio === "" || minutoinicio === "" || horafin === "" || minutofin === "") {
		flagvalidar.textContent = "Error: Debe ingresar todos los campos de horas.";
		isValid = false;
		return isValid;
	}
	if (horainicio < 0 || minutoinicio < 0 || horafin < 0 || minutofin < 0) {
		flagvalidar.textContent = "Error: Debe ingresar todos los campos de horas.";
		isValid = false;
		return isValid;
	}

	const errores = validarHorarioGestorIncidencia(hentrada, minentrada, hsalida, minsalida);


	if (errores.length > 0) {
		flagvalidar.textContent = errores[0].mensaje;
		isValid = false;
		return isValid;
	}

	if (hentrada && hsalida) {
		const minutosEntrada = hentrada * 60 + minentrada;
		const minutosSalida = hsalida * 60 + minsalida;
		const minutosPermitidos = obtenerMinutosHVi();

		if ((minutosSalida - minutosEntrada) > minutosPermitidos) {
			isValid = false;
			flagvalidar.textContent = `Error: Se supero el tiempo maximo de ${minutosPermitidos} minutos.`;
			return isValid;
		}
	}
...
function listenerHorasInicio(event) {
	const hinicio = event.target.value;
	const minicio = document.getElementById('mm_ini_gru');
	const hfinal = document.getElementById('h_fin_gru');
	const mfinal = document.getElementById('mm_fin_gru');
	const flagvalidar = document.getElementById('flag_validacion_horas');
	if (hinicio > 0) {
		minicio.disabled = false;
		hfinal.disabled = false;
	} else {
		minicio.disabled = true;
		hfinal.disabled = true;
		mfinal.disabled = true;
		minicio.value = "00";
		mfinal.value = "00";
		hfinal.value = "0";
		flagvalidar.innerHTML = "";
	...
	validarMinutosIncidencia(hinicio, minicio.value, hfinal.value, mfinal.value);

}
function listenerMinutosInicio(event) {
	const hinicio = document.getElementById('h_ini_gru');
	const minicio = document.getElementById('mm_ini_gru');
	const hfinal = document.getElementById('h_fin_gru');
	const mfinal = document.getElementById('mm_fin_gru');

	validarMinutosIncidencia(hinicio.value, minicio.value, hfinal.value, mfinal.value);
}
function listenerHorasFinal(event) {
	const hfinal = event.target.value;
	const mfinal = document.getElementById('mm_fin_gru');
	const hinicio = document.getElementById('h_ini_gru');
	const minicio = document.getElementById('mm_ini_gru');

	if (hfinal > 0) {
		mfinal.disabled = false;
	} else {
		mfinal.disabled = true;
		mfinal.value = "00";
	}

	validarMinutosIncidencia(hinicio.value, minicio.value, hfinal, mfinal.value);
}

function listenerMinutosFinal(event) {
	const hinicio = document.getElementById('h_ini_gru');
	const minicio = document.getElementById('mm_ini_gru');
	const hfinal = document.getElementById('h_fin_gru');
	const mfinal = event.target.value;

	validarMinutosIncidencia(hinicio.value, minicio.value, hfinal.value, mfinal);
	...
	if (document.getElementById("c_inc").value == "") {
		...
		if (confirm(msn2)) {
			var urlx =
				...
				"&iduser=" +
				iduser +
				"&accion=eliminar_incidencia_todo";
			//alert(urlx)
			//alert(urlx)
			ajaxc = createRequest();
			ajaxc.open("GET", urlx, true);
...
function mostrar_modulos_mant(opc) {
	...
	if (opc == "1") {
        ...
        document.getElementById("div_cambiodeclaves").style.display ="none";
    ...
    if (opc == "4") {
		document.getElementById("div_cambiodeclaves").style.display ="block";
		document.getElementById("mod_mant_motivoincidencias").style.display ="none";
		document.getElementById("mod_mant_olas").style.display = "none";
		document.getElementById("mod_mant_aplicativos").style.display = "none";
        
        var iframe              = document.getElementById("bandeja_cambioclaves");
        var page_pass           = "bandejas/bandeja_historico_claves.php";        
        iframe.style.visibility = "visible";
        iframe.src              = page_pass;
...
function grabar_aplicativo() {
	...
	var pag1 =
		"funciones_cot.php?aplicativo=" +
		aplicativo +
		"&iduser=" +
		iduser +
		"&accion=grabar_aplicativo";
...
function mostrar_detalle_usuarios() {
	...
	if (document.getElementById("c_supervisor").value == "0") {
		...
		if (
			document.getElementById("combo_gestor").value == "0" &&
			document.getElementById("c_supervisor").value == "T"
		) {
			...
			document.getElementById("load_1").innerHTML =
				"<img src=\"cargando.gif\" width='200px' height='200px' />";
			...
			ajaxc.onreadystatechange = function () {
				if (ajaxc.readyState == 4) {
					...
					document.getElementById("load_1").innerHTML = "";
					document.getElementById("d_bandeja_usuarioscot").style.display =
						"block";
					if (document.getElementById("combo_gestor").value == "0") {
						document.getElementById("d_bandeja_usuarioscot").style.height =
							"500px";
						document.getElementById("d_bandeja_usuarioscot").style.width =
							"1500px";
					} else {
						document.getElementById("d_bandeja_usuarioscot").style.height =
							"150px";
					...
					document.getElementById("d_bandeja_usuarioscot").innerHTML =
						ajaxc.responseText;
...
function cargar_automaticamente_usuarios(c_supervisor, c_gestor) {
	...
	parent.document.getElementById("load_1").innerHTML =
		"<img src=\"cargando.gif\" width='200px' height='200px' />";
	parent.document.getElementById("d_bandeja_usuarioscot").style.display =
		"none";
	...
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			...
			parent.document.getElementById("d_bandeja_usuarioscot").style.display =
				"block";
			parent.document.getElementById("d_bandeja_usuarioscot").innerHTML =
				ajaxc.responseText;
			parent.document.getElementById("bt_mostrar_detalle").style.display =
				"block";
		}
	};
	ajaxc.send(null);
...
function cambios_usuariocot(opc) {
	if (
		document.getElementById("usu_1").value == "-" ||
		document.getElementById("usu_1").value == "" ||
		document.getElementById("usu_1").value == " "
	) {
...
function exportar_aplicativos_usuarioscot() {
	...
	var url =
		"reporte_aplicativos_usuarioscot.php?iduser=" +
		iduser +
		"&c_supervisor=" +
		c_supervisor +
		"&c_gestor=" +
...
function grabar_motivos_inc() {
	...
	var pag1 =
		"funciones_cot.php?tipo_inc=" +
		tipo_inc +
		"&motivo_inc=" +
		motivo_inc +
		"&iduser=" +
		iduser +
		"&accion=grabar_motivos_inc";
...
function eliminar_gestor_inc(inc, dni, fecha,id_inc) {
	...
	var msn2 =
		"Desea Eliminar el detalle de la incidencia " +
		c_incidencia +
		" para el DNI: " +
		dni +
		" con fecha inicio: " +
	...
	if (confirm(msn2)) {
		...
		ajaxc.onreadystatechange = function () {
			if (ajaxc.readyState == 4) {
				//alert(ajaxc.responseText);
				alert(
					"Cierre la ventana y vuelva a ingresar para visualizar los cambios"
				);
				cerrar_edit_incidencia();
			}
		};
		ajaxc.send(null);
	}
...
function cargar_horarios() {
	...
	if (!archivo) {
		...
		document.getElementById("mensaje_carga_horarios").innerHTML =
			"<p class='warning_color'>Eliga un archivo. <img src='image/warning.png' width='17px' height='17px'/></p>";
		return;
	}
	var pag =
		"funciones_cot.php?iduser=" + iduser + "&accion=cargar_horarios_csv";
	document.getElementById("btn_cargar_file").innerHTML =
		"<img src='cargando.gif' width='22' height='22'/>Cargando..</button>";
	...
	ajax.onreadystatechange = function () {
		...
		if (ajax.readyState == 4 && ajax.status == 200) {
			...
			document.getElementById("btn_cargar_file").innerHTML =
				"<img src='image/upload.gif' width='22' height='22'/>Cargar archivo</button>";
			document.getElementById("btn_cargar_file").disabled = false;
		} else if (ajax.status == 403 || ajax.status == 400 || ajax.status == 404) {
			document.getElementById("mensaje_carga_horarios").innerHTML =
				"<p class='error_color'> OCURRIO UN ERROR EN LA CARGA !!!<img src='image/Symbol-Error.gif' width='17px' height='17px'/></p>";
		}
	};
...
//13.10.2025
function calcular_tiempos_inc() {
	
	var modo_inc = document.getElementById("modalidad").value;
	...
	if (document.getElementById("modalidad").value == "0") {
		...
		if (modo_inc == "H") {
                ...
                if(document.getElementById("mm_ini_gru").value>59){
                    alert("Error en los minutos inicio");
                    document.getElementById("mm_ini_gru").value="";
                    document.getElementById("mm_ini_gru").focus();
                    return;
                }

                if(document.getElementById("mm_fin_gru").value>59){
                    alert("Error en los minutos fin");
                    document.getElementById("mm_fin_gru").value="";
                    document.getElementById("mm_fin_gru").focus();
                    return;
                }
	...
	if (
		document.getElementById("modalidad").value == "D" ||
	...
	var pag_inc ="funciones_cot.php?fec_ini="+fec_ini+"&fec_fin="+fec_fin+"&fec="+
		fec+"&modo="+modo_inc+"&hor_ini="+hor_ini+"&hor_fin="+hor_fin+
		"&accion=calcular_tiempo";

	//alert(pag_inc);

	ajaxc = createRequest();
	ajaxc.open("get", pag_inc, true);
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			var msn = ajaxc.responseText;			
			var msn = msn.split("|");			
			...
			//alert(msn)
			document.getElementById("tiempo_inc").value = msn[0];
			document.getElementById("tiempo_minutos").value = msn[1];
            validar_horarios();
		}
	}
	ajaxc.send(null);
...
function listar_incidencias_cot(dni_escogidos) {
	var iduser = document.getElementById("iduser").value;
	var fec1  = document.getElementById("inputg3").value
			...
			var fec1x    = fec1[0];
			var xfec_ini = fec1x.split("-");
			var f_inc  = xfec_ini[2] + "-" + xfec_ini[1] + "-" + xfec_ini[0];

	
	var pag_x = "listado_incidencias.php?dni_escogidos=" + dni_escogidos + "&iduser=" + iduser+ "&f_inc=" + f_inc;
	//alert(pag_x)
	ajaxc = createRequest();
	ajaxc.open("get", pag_x, true);
	ajaxc.onreadystatechange = function () {
		if (ajaxc.readyState == 4) {
			//alert(ajaxc.responseText)
			document.getElementById("div_listado_incidencias").innerHTML = ajaxc.responseText;
			document.getElementById("div_listado_incidencias").style.display = "block";
		}
	};
	ajaxc.send(null);
...
function muestra_horarios_gestor(tip) {
	
	
	if (document.getElementById("tp_incidencia").value==5){
	   var c_gestor = document.getElementById("c_gestor").value;
	
	}else{
		var c_gestor = document.getElementById("arr_escogidos").value;
	}
	
	var accion = "muestra_horarios_gestor";

	var pagh =
		"funciones_cot.php?c_gestor=" +
		c_gestor +
		"&tip= "+
		tip+
		"&accion=" +
	...
	ajax = createRequest();
	ajax.open("GET", pagh, true);
	ajax.onreadystatechange = function () {
		if (ajax.readyState == 4) {
			var resx = ajax.responseText;
			document.getElementById("div_horarios").innerHTML = resx;
			//alert (resx)
		}
	};
	...
	//listar_incidencias_cot(c_gestor)
}

function mostrar_motivo() {
    document.getElementById("div_noaprobados").style.display = "block";
}

function mostrar_div_cambiopass() {
    document.getElementById("cambio_pass").style.display = "block";
}

function cambiar_pass() {
    
    var login = document.getElementById("login").value;
    var n_clave = document.getElementById("n_clave").value;
    var c_motivoclave = document.getElementById("c_motivoclave").value;
    var accion = "cambiar_pass";

	var pagh =
		"funciones_cot.php?login=" +
		login +
		"&n_clave= "+
		n_clave+
		"&c_motivoclave=" +
	...
	ajax.onreadystatechange = function () {
		if (ajax.readyState == 4) {
			var resx_pass = ajax.responseText;
            alert(resx_pass)
            document.getElementById("cambio_pass").style.display = "none";			
			alert ("Se cambio Contraseña Satisfactoriamente")
            document.getElementById("n_clave").value="";
            document.getElementById("clave").value="";
...
function edicion_inc() {
    document.getElementById("tpincidencia").style.display = "none";
    document.getElementById("c_tpindicencia").style.display = "block";
    document.getElementById("div_motivo").style.display = "none";    
    document.getElementById("modalidad").style.display = "block";    
    document.getElementById("bt_aceptar").style.display = "block";    
    document.getElementById("fec_corregidas").style.display = "block";
    
    
}

function poner_incidencia(c_inc) {
    parent.document.getElementById("c_inc").value=c_inc;
}


function actualizar_indicencia() {
    var iduser = document.getElementById("iduser").value;
	var idperfil = document.getElementById("idperfil").value;
    var c_indicencia = document.getElementById("c_incidencia").value;
	var tp_incidencia = document.getElementById("c_mot_gru").value;
	var mot_incidencia = document.getElementById("combo_mot").value;	
	var tiempo_inc = document.getElementById("tiempo_inc").value;
    var tiempo_minutos = document.getElementById("tiempo_minutos").value;
	var obs_inc = document.getElementById("obs_gru").value;
	var c_doid_gru = document.getElementById("c_doid_gru").value;
	var combo_modalidad = document.getElementById("modalidad").value;
    
    if(combo_modalidad=="H"){       
        ...
        var fec2 = document.getElementById("inputg3").value;
			...
			var fec1x    = fec1[0];
			var xfec_ini = fec1x.split("-");
			var fec_ini  = xfec_ini[2] + "-" + xfec_ini[1] + "-" + xfec_ini[0] + " " + h_ini;

			var fec2     = fec2.split(" ");
			var fec2x    = fec2[0];
			var xfec_fin = fec2x.split("-");
			var fec_fin  = xfec_fin[2] + "-" + xfec_fin[1] + "-" + xfec_fin[0] + " " + h_fin;
    ...
    var pag_act =
					...
					"&idperfil=" +
					idperfil +
					"&accion=actualizar_incidencias_cot";

     //alert(pag_act)  

    ajaxp = createRequest();
	ajaxp.open("GET", pag_act, true);
	ajaxp.onreadystatechange = function () {
		if (ajaxp.readyState == 4) {
			var resp_act = ajaxp.responseText;
			//alert(resp_act);
            alert("Se actualiza la incidencia correctamente")
            cerrar_edit_incidencia();
		}
	};
	ajaxp.send(null);
...
function mostrar_msn_carga(sw) {
    

	var page =
					"../funciones_cot.php?sw=" +
					sw +
					"&accion=mostrar_carga_horarios";
	//alert(page)

	ajaxp = createRequest();
	ajaxp.open("GET", page, true);
	ajaxp.onreadystatechange = function () {
		if (ajaxp.readyState == 4) {
			var resp_hor = ajaxp.responseText;
			document.getElementById("div_msn_carga").style.display = "block";
			document.getElementById("div_msn_carga").innerHTML = resp_hor;
...
function editar_chorario(dni,fila,hor_ant){
	//alert(hor_ant)
	document.getElementById(fila).style.background = "#F9ED9C";
	document.getElementById("div_cambiohorario").style.display = "block";
	document.getElementById('x_dni').value=dni;
	document.getElementById('f_horario').value=fila;
	document.getElementById('hor_ant').value=hor_ant;
    //document.getElementById("txt_chorario").style.display = "none";
...
function actualizar_horarios() {
    ...
    var iduser = document.getElementById("iduser").value;
    var dni = document.getElementById("x_dni").value;
    var hor_ant = document.getElementById("hor_ant").value;
    var hor_nuevo = document.getElementById("c_horario").value;
    var obs_hor = document.getElementById("obs_hor").value;
    
    if (document.getElementById("c_horario").value=="0"){
    	alert("Escoga nuevo horario")
    	return
    }
	...
	var page1 =
					...
					"&obs_hor=" +
					obs_hor +
					"&accion=actualizar_horarios_gestor";
	//alert(page1)

	ajaxp = createRequest();
	ajaxp.open("GET", page1, true);
	ajaxp.onreadystatechange = function () {
		if (ajaxp.readyState == 4) {
			var resp_hor1 = ajaxp.responseText;
			//alert(resp_hor1)
			alert("Se actualizaron los horarios del gestor")
			document.getElementById("div_cambiohorario").style.display = "none";
			reload();
		}
	};
	ajaxp.send(null);
...
function mostrar_historico_horarios(dni,fila) {

	document.getElementById(fila).style.background = "#F0EAD6";


	var pag =
					"../funciones_cot.php?dni=" +
					dni +
					"&accion=mostrar_historico_horarios";
	//alert(pag)
	...
	ajaxp.onreadystatechange = function () {
		if (ajaxp.readyState == 4) {
			var resp_his = ajaxp.responseText;
			document.getElementById("div_historico_cambiohorarios").style.display = "block";
			document.getElementById("div_historico_cambiohorarios").innerHTML = resp_his;
