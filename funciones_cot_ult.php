							...
							for ($contador = 0; $contador < $diff + 1; $contador++) {
										...
										if ($validar == 1) {		
												...
												if (!$responseValidacion["error"]) {
														...
														$sql_inc = 
																"INSERT INTO cab_incidencia 
																		(id,cip,fec_reg,usu_reg,tp_incidencia,motivo_incidencia,fec_ini_inc,fec_fin_inc,obs_incidencia,nro_participantes,cod_incidencia,ejecuto,tiempo,modo,c_doid,dni,dias,estado_inc,fec_mov_est,usu_mov_est,tt_min) VALUES ('','$reg_ch1[3]',now(),'$iduser','$c_mot_gru','$c_mot_inc_gru','$fecha_inicia_incidencia', '$fecha_fin_incidencia','$observacion','$nro_escogidos', '$c_incidencia','','$tiempo_cal','$modo_gru', '$c_doid_gru','$dni_escogidos[$j]','1','$xest_inc',now(),'$iduser','$tiempo_c_min')";
														//echo $sql_inc;
							...
							if (!$responseValidacion["error"]) {
								...
								$sql_inc=
											...
											VALUES	
													...
													'$dif_tiempo','$modo_gru','$c_incidencia',
													'$c_doid_gru','$dni_escogidos[$i]','0','$nro_escogidos','$xest_inc',now(),'$iduser','$tiempo_c_min')";
											//echo "<br>".$sql_inc;	
...
if($accion=='muestra_horarios_gestor'){
	...
	echo "<input name='rango_dias' type='text' class='caja_texto_sb' id='rango_dias' value='$reg_rdias[7]' />";
	echo "<input name='rango_dias' type='text' class='caja_texto_sb' id='rango_dias' value='$reg_rdias[7]' />";
	...
	if  ($sw==1){
		...
		$nreg_contar = mysql_num_rows($res_contar);
      	...
      	if ($nreg_contar>0){
            ...
            echo "<td>$reg_contar[0] <img src='../image/vis.jpg' width='20' height='20' /></td>";
            echo "</tr>";
...
if($accion=='mostrar_historico_horarios'){
	...
	$hist ="select * from historico_cambio_horarios where gestor='$dni'";
		...
		echo "<table border='0' class='marco_tabla' width='100%'>";
				echo "<tr>";
