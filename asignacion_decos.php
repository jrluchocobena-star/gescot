...
<table width="90%" Class="marco_tabla_bandeja">
  <tr>
   ...
   <tr>
    ...
    <img id="bt_asigna_pedido_off" src="image/bt_asignar.jpg" alt="" width="169" height="55" style="display:none"/>    
    <td width="22%" onclick="javascript:menu_asig('3')" ><img src="image/PEDIDOS_.jpg" alt="" width="201" height="66" /></td>
    </td>
    <td width="22%" onclick="javascript:menu_asig('2')" ><img src="image/bandeja_pedido_.jpg" alt="" width="288" height="63" /></td>        
   <td width="22%" onclick="javascript:menu_asig('4')" ><img src="image/CRITERIOS_.jpg" alt="" width="198" height="62" /></td>     
    <? }else{ ?>
    <td colspan="3" >
    ...
    <? } ?>
    <td width="59%" valign="top" onclick="javascript:('<? echo $reg[1]?>','<? echo $reg[4]?>','<? echo $iduser;?>')" >
    <p>
    <? 
		$f_actual=date("Y-m-d");
...
<div id="bandejas_asignaciones" style="display:none">
        ...
        <div id="LIST_1" class="city">
          <iframe id="bandejas"  frameborder="0" vspace="0"  hspace="0"  marginwidth="0"  marginheight="0"
           width="90%"  scrolling="Auto"  height="500"> </iframe>
        </div> 
