...
if ($accion=="asignar_reglas"){
	...
	$c1="update tb_usuarios set estado='$criterio' where iduser='$user'";
	}
	
	if ($ncombo=="criterio_3"){
	$c1="update tb_usuarios set s_area='$criterio' where iduser='$user'";
	}
...
if ($accion=="registrar_usuario"){
	...
	if ($nreg_0 <1){	
		...
		$sql_1="INSERT INTO tb_usuarios(iduser,ncompleto,dni,cip,login,pass,perfil,estado,fec_reg,ape_pat,ape_mat,nombres,grupo,fec_nacimiento,ola)
		VALUES(LAST_INSERT_ID(),'$ncompleto','$dni','$cip','$login','$clave','$perfil','HABILITADO',now(),'$ape_pat',
		'$ape_mat','$nombres','$grupo','$fec_nac','$ola')";
		//echo $sql_1;
...
$res_6= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO MULTICONSULTA','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_multiconsulta')");

$res_7= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO INTRAWAY','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_intraway')");

$res_8= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB UNIFICADA','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_web_unificada')");	
	
$res_9= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO PSI','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_psi')");	
				
$res_10= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO ATIS','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_atis')");	
			
$res_11= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO CMS','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_cms')");				

$res_12= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO GESTEL','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_gestel')");				

$res_13= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB INCIDENCIAS PSI','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_incidencias_psi')");				

$res_14= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO PDM','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_pdm')");				

$res_15= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO CLEAR VIEW','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_clear_view')");				

$res_16= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB SARA','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_web_sara')");				

$res_17= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB ASEGURAMIENTO','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_web_aseguramiento')");				

$res_18= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO ARPU CALCULADORA','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_arpu_calculadora')");				

$res_19= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO GENIO','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_genio')");				

$res_20= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB ASIGNACIONES','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_web_asignaciones')");				

$res_21= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB SIGTP MAPA GIG','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_web_sigtp_mapa_gig')");	

$res_22= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO RED','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_red')");	

$res_23= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO GESCOT','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_gescot')");	

$res_24= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO GENESYS','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','registrado','ACTIVO','t_usuario_genesys')");			
...
if ($accion=="actualizar_datos_usu_horiz"){
	...
	*/
	...
	$fec_nac = $_GET["fec_nac"];
	$motivo_cambio = "SE ACTUALIZO EL USUARIO CON DNI ".$dni."|".$_GET["motivo_cambio"];	
	$ncompleto = $_GET["ncompleto"];	
	$ape_pat = $_GET["ape_pat"];
	$ape_mat = $_GET["ape_mat"];
	$nombres = $_GET["nombres"];
	...
	$sql_usu1="update tb_usuarios set correo_personal='$correo_p',correo_w='$correo_w',celular1='$celular1',celular2='$celular2',grupo='$grupo',
	local='$local',anexo='$anexo',c_supervisor='$supervisor',c_monitor='$monitor',perfil='$perfil',pc='$pc',monitor='$pcmonitor',
	c_emergencia='$c_emergencia',fec_nacimiento='$fec_nac',n_area='$area',estado='$xestado',ncompleto='$ncompleto',ape_pat='$ape_pat',
	ape_mat='$ape_mat',nombres='$nombres',dni='$dni',cip='$cip',ola='$olas'
	where iduser='$id_g'";
	//echo $sql_usu1;
	...
	*/
	...
	$sql_2="INSERT INTO movimiento_usuarios(id,proceso,usu_mov,fec_mov,obs,pc,dato)
	VALUES(LAST_INSERT_ID(),'ACTUALIZACION DE USUARIO WEB GESCOT','$iduser',now(),'$motivo_cambio','$pc_sis','$dni')";
	//echo $sql_2;
	$res_2= mysql_query($sql_2);
	...
	if ($perfil=="5"){		
		$sql_5="insert into tb_monitores values('$id_g','$ncompleto','1','','')";
		//echo $sql_3;
		$res_5= mysql_query($sql_5);	
	...
	$sql6="insert into movimientos_maestra values('','$dni','$dato','-','$tarea',now(),'$d_hoy','2050-01-01','$iduser','','ACTIVO')";
		//echo "<br>".$sql2;
...
if ($accion=="grabar_incidencia"){
	...
	/***************************************************/
	$msn="SE REGISTRO LA INCIDENCIA PARA ".$cip." con codigo incidencia ".$idfranqueo;
	
	$sql_2="INSERT INTO movimiento_incidencias(id,estado,usu_mov,fec_mov,obs,dato,pc)
	VALUES(LAST_INSERT_ID(),'REGISTRO','$iduser',now(),'$msn','$cip','$pc_asig')";
	//echo $sql_2;
	$res_2= mysql_query($sql_2);
...
if ($accion=="grabar_capacitacion"){
	...
	*/
	$msn="SE REGISTRO LA CAPACITACION PARA ".$cip." con codigo incidencia ".$idfranqueo;
...
if ($accion=="borrar_incidencia"){
	...
	$msn="SE ELIMINO EL REGISTRO ".$id;
	
	$sql_2="INSERT INTO movimiento_incidencias(id,estado,usu_mov,fec_mov,obs,dato,pc)
	VALUES(LAST_INSERT_ID(),'ELIMINAR ','$iduser',now(),'$msn','$id','$pc_asig')";
	//echo $sql_2;
	$res_2= mysql_query($sql_2);	
...
if ($accion=="act_incidencia"){
	...
	$msn="SE ACTUALIZO EL REGISTRO ".$cip;
	
	$sql_2="INSERT INTO movimiento_incidencias(id,estado,usu_mov,fec_mov,obs,pc,dato,pc)
	VALUES(LAST_INSERT_ID(),'ACTUALIZAR','$iduser',now(),'$msn','$pc','$cip','$pc_asig')";
	//echo $sql_2;
	$res_2= mysql_query($sql_2);
...
//			$cc="campo13 LIKE '%$ape_pat%' or campo14like '%$ape_mat%'";
	...
	if($bd=="TERADATA"){
		$cad	="sel *  from dbi_public.JRR_Contactabilidad_COT where $cc";
		//echo $cad;
...
if($accion=="detalle_maestra_reniec"){
...
if($accion=="grabar_movimientos_usuarios"){
	...
	if ($nrg > 0){
		...
		$sql2="insert into movimientos_maestra values('','$xdni_mov','$xusu_mov','$xapli_mov','ACT. USUARIO',now(),'$xfec_mov','2050-01-01','$iduser','','ACTIVO','$apli')";
		//echo "<br>".$sql2;
...
if ($accion=="grabar_incidencia_masiva"){
	...
	while($reg_0 = mysql_fetch_row($rs_0)){	
		...
		$sql_2="INSERT INTO movimiento_usuarios(id,proceso,usu_mov,fec_mov,obs,pc,dato)
		VALUES(LAST_INSERT_ID(),'ACTUALIZACION DE USUARIO WEB GESCOT','$iduser',now(),
		'SE ACTUALIZO MASIVAMENTE LOS DNI $dni','$pc','$dni')";
		//echo $sql_2;
		$res_2= mysql_query($sql_2);
...
tb_usuarios where estado='HABILITADO' and grupo='COT-TDP' 
...
//echo $lista;
	...
	while($reg_lis=mysql_fetch_row($res_lis)){	
		...
		*/
		...
		echo "<td class='caja_texto_pe'>";		// SUPERVISOR		
		echo $rg_s[0]; 				
		echo "</td>";
		...
		echo "<td class='caja_texto_pe'>";		// C HORARIO		
		echo $c_hor; 				
		echo "</td>";
		
		echo "<td class='caja_texto_pe'>";		// HORARIO		
		echo $n_hor; 				
		echo "</td>";
...
if($accion=="mostrar_horarios_gestores"){
	...
	for ($i = 0; $i < $nro_escogidos + 1 ; $i++) {
		...
		while($reg_hor=mysql_fetch_row($res_hor)){	
			...
			echo "<td class='caja_texto_pe'>$reg_hor[2]</td>";
...
if ($accion=="validar_horarios_incidencias"){
	...
	if ($reg_valida[0] > 2 ){   // VALIDA SI ES MAYOR A 2 DIAS
...
if ($accion=="grabar_incidencias_cot"){
	...
	if ($reg_valida[0] > 30 ){   // VALIDA SI ES MAYOR A 2 DIAS
		echo "0|Atencion: Solo se puede registrar incidencias con 2 dias de anterioridad";
	}else{
		if ($_GET["modo_gru"]=="H"){  // Si modo es HORAS
				...
				if ($reg_c0[5]==""){
					...
					if ($hor_ini_inc <=  $hor_ini_horario and $hor_fin_inc >=  $hor_fin_horario ) { // fuera de rango al inicio y al final
							...
							if ($hor_ini_inc <=  $hor_ini_horario and $hor_fin_inc <= $hor_ini_horario )  { // antes del horario 
								...
								$dif_tiempo   = "00:00";
								$error="0|Nota: Las horas de incidencias estan fuera del horario|Se trato de registrar la incidencia con las siguientes horas $hor_ini_inc - $hor_fin_inc";									
								$xest = 3;		
...
if ($accion=="mostrar_bandeja_aprobaciones"){
  ...
  $m_actual=date("Y-m");
  			...
  			$lista="select * from cab_incidencia where usu_reg='$usu_reg' and estado_inc='$est' and substr(fec_ini_inc,1,7)='$m_actual'	
			group by cod_incidencia order by fec_mov_est desc";
			//echo "<br>".$lista;
			$res_lis = mysql_query($lista);
			$nreg = mysql_num_rows($res_lis);
		  ...
		  $i=0;
				...
				while($reg_lis=mysql_fetch_row($res_lis)){	
					...
					*/
					...
					if ($reg_lis[13]=="D"){ // POR DIAS MAYOR A 2 DIAS 
						/*
						$date1 = new DateTime($reg_lis[6]);
						...
						if ($reg_lis[5]=="800"){
						$nuevafecha = strtotime ( '-2 month' , strtotime ( $reg_lis[6] ) ) ;
						...
						echo "<td class='caja_texto_peke'>";		//fecini		
						echo $nuevafecha." ".$rg_hor[8];	
						echo "</td>";
						*/
						
						$c_hor="SELECT count(*) FROM cab_incidencia WHERE cod_incidencia='$reg_lis[10]'";
						//echo $c_hor;
						$rs_chor = mysql_query($c_hor);											
						$rg_chor = mysql_fetch_row($rs_chor);
						
						//echo $rg_chor[0];
						
						if ($rg_chor[0]>1){
						$hor="SELECT cod_incidencia, min(fec_ini_inc),max(fec_fin_inc) FROM cab_incidencia 
						WHERE cod_incidencia='$reg_lis[10]' and modo='D'
...
if ($accion=="grabar_movimiento_maestra"){
	$iduser=$_GET["iduser"];
	$dni=$_GET["dni"];
	$t_usuario_arpu_calculadora=$_GET["t_usuario_arpu_calculadora"];
	$t_usuario_atis=$_GET["t_usuario_atis"];
	$t_usuario_clear_view=$_GET["t_usuario_clear_view"];
	$t_usuario_cms=$_GET["t_usuario_cms"];
	$t_usuario_genesys=$_GET["t_usuario_genesys"];
	$t_usuario_genio=$_GET["t_usuario_genio"];
	$t_usuario_gescot=$_GET["t_usuario_gescot"];
	$t_usuario_gestel=$_GET["t_usuario_gestel"];
	$t_usuario_incidencias_psi=$_GET["t_usuario_incidencias_psi"];
	$t_usuario_intraway=$_GET["t_usuario_intraway"];
	$t_usuario_multiconsulta=$_GET["t_usuario_multiconsulta"];
	$t_usuario_pdm=$_GET["t_usuario_pdm"];
	$t_usuario_psi=$_GET["t_usuario_psi"];
	$t_usuario_red=$_GET["t_usuario_red"];
	$t_usuario_toa=$_GET["t_usuario_toa"];
	$t_usuario_web_aseguramiento=$_GET["t_usuario_web_aseguramiento"];
	$t_usuario_web_asignaciones=$_GET["t_usuario_web_asignaciones"];
	$t_usuario_web_sara=$_GET["t_usuario_web_sara"];
	$t_usuario_web_sigtp_mapa_gig=$_GET["t_usuario_web_sigtp_mapa_gig"];
	$t_usuario_web_unificada=$_GET["t_usuario_web_unificada"];

$res_6= mysql_query("insert into movimientos_maestra VALUES('','$dni','$t_usuario_multiconsulta','USUARIO MULTICONSULTA','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_multiconsulta')");

$res_7= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO INTRAWAY','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_intraway')");

$res_8= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB UNIFICADA','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_web_unificada')");	
	
$res_9= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO PSI','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_psi')");	
				
$res_10= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO ATIS','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_atis')");	
			
$res_11= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO CMS','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_cms')");				

$res_12= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO GESTEL','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_gestel')");				

$res_13= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB INCIDENCIAS PSI','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_incidencias_psi')");				

$res_14= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO PDM','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_pdm')");				

$res_15= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO CLEAR VIEW','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_clear_view')");				

$res_16= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB SARA','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_web_sara')");				

$res_17= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB ASEGURAMIENTO','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_web_aseguramiento')");				

$res_18= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO ARPU CALCULADORA','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_arpu_calculadora')");				

$res_19= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO GENIO','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_genio')");				

$res_20= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB ASIGNACIONES','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_web_asignaciones')");				

$res_21= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO WEB SIGTP MAPA GIG','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_web_sigtp_mapa_gig')");	

$res_22= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO RED','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_red')");	

$res_23= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO GESCOT','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_gescot')");	

$res_24= mysql_query("insert into movimientos_maestra VALUES('','$dni','','USUARIO GENESYS','ACT. USUARIO',NOW(),CURDATE(),'','$iduser','Registro por Modulo','ACTIVO','t_usuario_genesys')");		
...
if ($accion=="act_contacto_tdata"){
	...
	$sql_tdata_1="INSERT INTO DBI_COT.LS_COT_LISTANEGRA
	select top 1 '','DNI','$dni','$telefono',ape_paterno,ape_materno,nombres,nombre_completo,operador,'$v_combo','$hoy','$iduser','$pc','$v_combo'
	from dbi_public.JRR_Contactabilidad_COT where nro_documento='$dni'";
	//echo $sql_tdata_1;
	...
	$sql_tdata_2="INSERT INTO DBI_COT.lc_movimiento_contactos(id,proceso,usu_mov,fec_mov,obs,pc_sis,pc_asig,dato)
	VALUES('','ACTUALIZACION CONTACTABILIDAD: $v_combo','$iduser',now(),
	'SE ACTUALIZO EL $telefono DEL CLIENTE CON DNI $dni','$pc','$pc_asig','$telefono')";
	//echo $sql_tdata_2;
