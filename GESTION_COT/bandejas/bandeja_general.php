...
$cad="select * from cab_programacion_extra order by fec_ini_inc desc";
//<echo $cad;
$res =mysql_query($cad);		
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#99CC99" bgcolor="#FFFFFF" 
...
<thead>
  <tr>
			...
			echo "<th class='table-filterable table-sortable:default'>FEC.INICIO</th>";
			
			echo "<th class='table-filterable table-sortable:default'>FEC.FIN</th>";
												
			echo "<th class='table-filterable table-sortable:default'>PROCESO</br>";							
