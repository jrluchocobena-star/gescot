...
var dhtmlwindow={
imagefiles:['dhtmlmodal/windowfiles/min.gif', 'dhtmlmodal/windowfiles/close.gif', 'dhtmlmodal/windowfiles/restore.gif', 'windowfiles/resize.gif'], //Path to 4 images used by script, in that order
...
init:function(t){
	...
	//domwindowdata+='DHTML Window <div class="drag-controls"><img src="'+this.imagefiles[0]+'" title="Minimize" /><img src="'+this.imagefiles[1]+'" title="Close" /></div>' // se visualiza la X en la ventana
